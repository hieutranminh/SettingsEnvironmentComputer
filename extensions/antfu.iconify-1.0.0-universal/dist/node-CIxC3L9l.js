...
function ns() {
	return vo || (vo = 1, function(i, o$1) {
		(function(a, l) {
			...
			function ui(e) {
				ue(e);
				bn(e, /* @__PURE__ */ new TypeError("Reader was released"));
			}
			...
			function fi(e, t$1) {
				const s = new pn(ze(e), t$1), f$1 = Object.create(yn);
			...
			function Tn(e, t$1 = "sync", r) {
				if (r === void 0) if (t$1 === "async") {
					if (r = St(e, Sr), r === void 0) return ci(Tn(e, "sync", St(e, Symbol.iterator)));
			...
			function Be(e) {
				...
				e._pulling = !0;
				g(e._pullAlgorithm(), () => (e._pulling = !1, e._pullAgain && (e._pullAgain = !1, Be(e)), null), (s) => (Z(e, s), null));
			}
			...
			function zn(e, t$1, r, s, f$1, c, d) {
				...
				g(T(r()), () => (t$1._started = !0, Be(t$1), null), (R) => (Z(t$1, R), null));
			}
			...
			function Ai(e, t$1) {
				var r;
				ne(e, t$1);
				return { min: mr((r = e?.min) !== null && r !== void 0 ? r : 1, `${t$1} has member 'min' that`) };
			}
			...
			class we {
				...
				read(t$1, r = {}) {
					...
					if (_e(t$1.buffer)) return b(/* @__PURE__ */ new TypeError("view's buffer has been detached"));
					let s;
					try {
						s = Ai(r, "options");
					} catch (y) {
					...
					const f$1 = s.min;
					if (f$1 === 0) return b(/* @__PURE__ */ new TypeError("options.min must be greater than 0"));
					if (yi(t$1)) {
						if (f$1 > t$1.byteLength) return b(/* @__PURE__ */ new RangeError("options.min must be less than or equal to view's byteLength"));
					} else if (f$1 > t$1.length) return b(/* @__PURE__ */ new RangeError("options.min must be less than or equal to view's length"));
					if (this._ownerReadableStream === void 0) return b(yt("read from"));
					let c, d;
					const p = A((y, C) => {
						c = y, d = C;
			...
			function Wi(e) {
				ue(e);
				Mn(e, /* @__PURE__ */ new TypeError("Reader was released"));
			}
			...
			class Re {
				...
				abort(t$1 = void 0) {
					return Le(this) ? De(this) ? b(/* @__PURE__ */ new TypeError("Cannot abort a stream that already has a writer")) : Bt(this, t$1) : b(Ot("abort"));
				}
				close() {
					return Le(this) ? De(this) ? b(/* @__PURE__ */ new TypeError("Cannot close a stream that already has a writer")) : oe(this) ? b(/* @__PURE__ */ new TypeError("Cannot close an already-closing stream")) : Hn(this) : b(Ot("close"));
				}
				getWriter() {
			...
			function $i(e, t$1, r, s, f$1 = 1, c = () => 1) {
				...
				Nn(d);
				return Kn(d, Object.create($e.prototype), e, t$1, r, s, f$1, c), d;
			}
			...
			function qr(e) {
				...
				g(e._writableStreamController[pt](r._reason), () => (r._resolve(), Wt(e), null), (f$1) => (r._reject(f$1), Wt(e), null));
			}
			...
			class de {
				...
				close() {
					...
					return t$1 === void 0 ? b(at("close")) : oe(t$1) ? b(/* @__PURE__ */ new TypeError("Cannot close an already-closing stream")) : Vn(this);
				}
				releaseLock() {
			...
			function Gn(e, t$1) {
				...
				if (oe(r) || c === "closed") return b(/* @__PURE__ */ new TypeError("The stream is closing or closed and cannot be written to"));
			...
			function Kn(e, t$1, r, s, f$1, c, d, p) {
				...
				Or(e, Fr(t$1));
				g(T(r()), () => (t$1._started = !0, qt(t$1), null), (P) => (t$1._started = !0, Wr(e, P), null));
			}
			...
			function ra(e, t$1, r) {
				...
				if (!oe(s) && s._state === "writable") Or(s, Fr(e));
				qt(e);
			}
			...
			function oa(e, t$1) {
				...
				g(e._writeAlgorithm(t$1), () => {
					Ui(r);
					const f$1 = r._state;
					if (wr(e), !oe(r) && f$1 === "writable") Or(r, Fr(e));
					return qt(e), null;
			...
			function st(e) {
				...
				e._pulling = !0;
				g(e._pullAlgorithm(), () => (e._pulling = !1, e._pullAgain && (e._pullAgain = !1, st(e)), null), (s) => (J(e, s), null));
			}
			...
			function ao(e, t$1, r, s, f$1, c, d) {
				...
				g(T(r()), () => (t$1._started = !0, st(t$1), null), (R) => (J(t$1, R), null));
			}
			...
			class L {
				...
				cancel(t$1 = void 0) {
					return Te(this) ? Ce(this) ? b(/* @__PURE__ */ new TypeError("Cannot cancel a stream that already has a reader")) : X(this, t$1) : b(Ie("cancel"));
				}
				...
				pipeThrough(t$1, r = {}) {
					...
					return Q(oo(this, s.writable, f$1.preventClose, f$1.preventAbort, f$1.preventCancel, f$1.signal)), s.readable;
				}
				pipeTo(t$1, r = {}) {
					if (!Te(this)) return b(Ie("pipeTo"));
					if (t$1 === void 0) return b("Parameter 1 is required in 'pipeTo'.");
					if (!Le(t$1)) return b(/* @__PURE__ */ new TypeError("ReadableStream.prototype.pipeTo's first argument must be a WritableStream"));
					let s;
					try {
					...
					return Ce(this) ? b(/* @__PURE__ */ new TypeError("ReadableStream.prototype.pipeTo cannot be used on a locked ReadableStream")) : De(t$1) ? b(/* @__PURE__ */ new TypeError("ReadableStream.prototype.pipeTo cannot be used on a locked WritableStream")) : oo(this, t$1, s.preventClose, s.preventAbort, s.preventCancel, s.signal);
				}
				tee() {
			...
			function ut(e, t$1, r, s = 1, f$1 = () => 1) {
				...
				Ur(c);
				return ao(c, Object.create(he.prototype), e, t$1, r, s, f$1), c;
			}
			n$1(ut, "CreateReadableStream");
			function uo(e, t$1, r) {
				const s = Object.create(L.prototype);
				Ur(s);
				return zn(s, Object.create(ce.prototype), e, t$1, r, 0, void 0), s;
			}
			...
			function X(e, t$1) {
				...
				return F(e._readableStreamController[ar](t$1), l);
			}
			...
			function $a(e) {
				...
				Oe(r);
				xr(t$1, /* @__PURE__ */ new TypeError("TransformStream terminated"));
			}
...
var ht = class {
	...
	async formData() {
		...
		const { toFormData: a } = await import("./multipart-parser-BQpy2m7i.js");
		return a(this.body, o$1);
	}
	async blob() {
		const o$1 = this.headers && this.headers.get("content-type") || this[N].body && this[N].body.type || "";
		return new Ze([await this.arrayBuffer()], { type: o$1 });
	}
	async json() {
...
const Bs = f(vs()), { stat: tn } = promises, Ws = n$1((i, o$1) => Do(statSync(i), i, o$1), "blobFromSync"), ks = n$1((i, o$1) => tn(i).then((a) => Do(a, i, o$1)), "blobFrom"), qs = n$1((i, o$1) => tn(i).then((a) => $o(a, i, o$1)), "fileFrom"), Os = n$1((i, o$1) => $o(statSync(i), i, o$1), "fileFromSync"), Do = n$1((i, o$1, a = "") => new Ze([new ir({
	path: o$1,
	size: i.size,
...
async function Mo(i, o$1) {
	return new Promise((a, l) => {
		...
		if (m.protocol === "data:") {
			const g = ts(u.url);
			a(new H(g, { headers: { "Content-Type": g.typeFull } }));
			return;
		}
		...
		b.on("error", (g) => {
			...
			if (Xr(g.statusCode)) {
				...
				switch (u.redirect) {
					...
					default: return l(/* @__PURE__ */ new TypeError(`Redirect option '${u.redirect}' is not a valid value of RequestRedirect`));
				}
			}
			E && g.once("end", () => {
...
n$1(Ho, "getWrapper");
function Ls(i, o$1) {
	return new (Ho(Object.getPrototypeOf(o$1)))(i, o$1);
}
n$1(Ls, "wrapEvent");
function Ds(i) {
