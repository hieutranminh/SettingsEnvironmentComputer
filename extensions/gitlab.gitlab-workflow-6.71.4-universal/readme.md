...
- [Security Findings](https://docs.gitlab.com/editor_extensions/visual_studio_code/#view-security-findings) requires extension version 3.74.0 or later, and GitLab Ultimate.
