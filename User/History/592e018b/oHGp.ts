...
interface IMessageDialogReturn {
  // Configuration
  configure: (config: Partial<IMessageDialogConfig>) => void
  getConfig: () => IMessageDialogConfig

  // Show methods
  showSuccess: (title: string, message: string | string[] | IErrorDetail[], options?: Partial<Omit<IMessageConfig, 'type' | 'title' | 'message'>>) => void
  showInfo: (title: string, message: string | string[] | IErrorDetail[], options?: Partial<Omit<IMessageConfig, 'type' | 'title' | 'message'>>) => void
  showWarning: (title: string, message: string | string[] | IErrorDetail[], options?: Partial<Omit<IMessageConfig, 'type' | 'title' | 'message'>>) => void
  showError: (message?: string | string[] | IErrorDetail[], options?: Partial<Omit<IMessageConfig, 'type' | 'title' | 'message'>>) => void
  showSecondary: (title: string, message: string | string[] | IErrorDetail[], options?: Partial<Omit<IMessageConfig, 'type' | 'title' | 'message'>>) => void
  showContrast: (title: string, message: string | string[] | IErrorDetail[], options?: Partial<Omit<IMessageConfig, 'type' | 'title' | 'message'>>) => void
  showErrors: (errors: string[]) => void
  showImmediateDialog: (config: IMessageConfig) => Promise<void>
...
export const useMessageDialog = (): IMessageDialogReturn => {
  ...
  const showImmediateDialog = (config: IMessageConfig): Promise<void> => {
...
export type { IMessageConfig as MessageConfig, IDialogAction as DialogAction, IDialogStyle as DialogStyle, IMessageDialogConfig as MessageDialogConfig, IErrorDetail as ErrorDetail }
