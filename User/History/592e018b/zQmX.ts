...
export type {
  IMessageConfig as MessageConfig,
  IDialogAction as DialogAction,
  IDialogStyle as DialogStyle,
  IMessageDialogConfig as MessageDialogConfig,
  IErrorDetail as ErrorDetail,
}
