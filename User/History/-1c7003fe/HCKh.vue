<template>
  ...
  <template v-if="filters.shopId">
    ...
    <ClientsByPeriodTable ref="clientsByPeriodTableRef" :clientSummary="clientSummary" :memberSummary="memberSummary" />
...
const { clientSummary, memberSummary, fetchReport } = useClientsByPeriodReport()
