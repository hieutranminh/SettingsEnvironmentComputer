  ...
  methods: {
    ...
    async loadModelsData() {
      try {
        ...
        console.log('AI Setup Models Result:', result)
        ...
        console.log('AI Setup Models Data:', result.data)

        // Map data from API to options format
        this.aiModelOptions = result.data.items(item => ({
          value: item.modelId,
          text:  item.model,
        }))

        console.log('AI Model Options:', this.aiModelOptions)
      } catch (error) {
