    ...
    return {
      table_data: {
        fields: [
          ...
          { field: 'prompt_ko', label: { line1: 'ai-setup.label-prompt', line2: 'ai-setup.label-korean' }, multi_th: true, expand: true },
          { field: 'prompt_en', label: { line1: 'ai-setup.label-prompt', line2: 'ai-setup.label-english' }, multi_th: true, expand: true },
        ],
        rows:       [],
        pagination: {},
        options:    {
    ...
    async onChangeAIModel() {
      try {
        ...
        const result = await aiSetupApi.updateAISetupAsync({
          ...
          prompt:        this.selectedRow.prompt,
        })
