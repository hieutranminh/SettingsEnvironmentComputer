...
export default {
  ...
  methods: {
    ...
    handleClientLookupFromAhaAi(clientLookupResult) {
      console.log('handleClientLookupFromAhaAi', clientLookupResult)
      this.handleSearch({
        searchCondition:  this.searchFilter?.searchCondition || options.clients_enums.client_search_condition_type.name_or_phone,
        searchInBranches: this.searchFilter?.searchInBranches ?? this.x_user?.is_client_searched_in_branches ?? false,
    ...
    handleSearchAvailableTimesFromAhaAi(availableTimesResult) {
      console.log('handleSearchAvailableTimesFromAhaAi', availableTimesResult)
    },
  },
}
</script>
