...
export default {
  ...
  methods: {
    ...
    getPrintSections() {
      ...
      // Chart as CANVAS (only chart-line, excluding display-item selector and legend)
      if (this.$refs.chartSection?.$refs.chartLine) {
        sections.push({
          ref_type:    print_options.print_ref_type.canvas,
          section_ref: this.$refs.chartSection.$refs.chartLine.$el,
        })
      }
