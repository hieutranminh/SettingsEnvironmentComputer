...
export default {
  ...
  methods: {
    ...
    getPrintSections() {
      ...
      // Chart as CANVAS (only chart-container, excluding display-item selector)
      if (this.$refs.chartSection?.$refs.chartContainer) {
        sections.push({
          ref_type:    print_options.print_ref_type.canvas,
          section_ref: this.$refs.chartSection.$refs.chartContainer,
        })
      }
