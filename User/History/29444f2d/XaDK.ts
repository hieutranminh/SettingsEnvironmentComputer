/**
 * IMPROVED VERSION - usePdfText.ts
 * Demonstrates better structure, readability, and maintainability
 */
...
// ✅ Interface to reduce parameter complexity
...
/**
 * Improved PDF text processing composable
 * @returns PDF text processing utilities with better separation of concerns
 */
export const usePdfText = (): UsePdfTextReturn => {
  ...
  const shouldBreakPage = (
    ...
    return (
      ...
      currentY > headerEndPosition + TEXT_CONSTANTS.MIN_SPACE_FROM_HEADER
    )
  }
  ...
  const processText = async (
    ...
    try {
      ...
      // ✅ Create rendering context to reduce parameter passing
      const renderContext: TextRenderingContext = {
        ...
        maxWidth: getTextWidth(pdf.internal.pageSize.width),
      }
 ...
 * ✅ Broke down complex processTextElement function into smaller, focused functions
 * ✅ Reduced parameter complexity using context interfaces
 * ✅ Improved readability with better function names and separation of concerns
 * ✅ Added clear single-responsibility functions
 * ✅ Maintained same functionality while improving maintainability
