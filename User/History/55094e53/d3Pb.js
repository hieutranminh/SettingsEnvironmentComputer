...
const reportRoutes = [
  ...
  {
    path:      '/report/comprehensive-analysis',
    name:      'report-comprehensive-analysis',
    component: () => import(/* webpackChunkName: "view-[request]" */ 'Pages/report/report-comprehensive-analysis/report-comprehensive-analysis.vue').catch(handleLoadingChunksFailed),
    meta:      {
      preload: true,
    },
  },
  {
    path:      '/report/staff-performance-analysis',
    name:      'report-staff-performance-analysis',
    component: () => import(/* webpackChunkName: "view-[request]" */ 'Pages/report/report-staff-performance-analysis/report-staff-performance-analysis.vue').catch(handleLoadingChunksFailed),
    meta:      {
      preload: true,
    },
  },
