...
import type { FakeDataType, DataTypeConfig, DataCategory, CategoryConfig, CreateClientPayload } from '../types'
  ...
  <div class="popup-container">
    ...
    <div v-if="activeTab === 'api'" class="tab-content api-tab">
      ...
      <div class="create-client-section">
        ...
        <div class="action-buttons">
          ...
          >
            ...
            <span v-else>🎯</span>
            {{ isCreatingClient ? 'Creating...' : `Create ${clientCount} Client${clientCount > 1 ? 's' : ''}` }}
          </button>

          <button class="preview-btn" @click="previewClientPayload">
            🔍 Preview Payload
          </button>
        </div>
      </div>
      ...
      <div v-if="previewPayload" class="preview-section">
        <div class="preview-header">
          ...
          <button class="copy-payload-btn" @click="copyPayloadToClipboard">
            📋 Copy
          </button>
        </div>
    ...
    <footer class="footer">
      <span class="footer-text">
        {{ activeTab === 'generator' ? 'Right-click on any input field for quick access' : 'Ahasoft Salon API Client' }}
      </span>
    </footer>
  </div>
</template>
