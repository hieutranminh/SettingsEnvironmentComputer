...
module.exports = {
  meta: {
    ...
    schema: [],
    messages: {
      missingHandlePrefix: 'Functions in Vue script setup must start with "handle" prefix (except: use*, get*, set*, is*, has*, can*, should*, will*, did*)',
    },
  },
  ...
  create(context) {
    ...
    const allowedPrefixes = [
      'use', 'get', 'set', 'is', 'has', 'can', 'should', 
      'will', 'did', 'on', 'off', 'add', 'remove', 'update', 
      'delete', 'create', 'find', 'search', 'filter', 'map', 
