...
export default [
    ...
    rules: {
      ...
      'no-restricted-syntax': [
        'error',
        {
          ...
          message: 'Không được hard-code "UTC", hãy đưa vào constants.',
        },
      ],
    },
  },
  ...
  {
    files: ['eslint.config.ts', 'src/constants/**/*.ts', 'src/composables/print/constants/**/*.ts'],
    rules: {
