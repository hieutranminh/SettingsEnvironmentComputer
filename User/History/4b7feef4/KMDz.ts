...
export default [
  ...
  // Supports Vue 3 Composition API, <script setup>, and TypeScript
  {
    ...
    rules: {
      ...
      /**
       * Enforce maximum lines for template and script blocks in Vue SFC files
       *
       * Why: Large template and script blocks make components hard to maintain
       * Configuration:
       * - templateMaxLines: 200 - Maximum lines for template block
       * - scriptMaxLines: 300 - Maximum lines for script block
       * - Style blocks are excluded from this rule
       *
       * Example:
       * ❌ Bad: Template with 300+ lines or script with 400+ lines
       * ✅ Good: Split large components into smaller, focused components
       */
      'custom/vue-sfc-max-lines': [
        'error',
        {
