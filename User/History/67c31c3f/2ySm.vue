    ...
    <div class="modal-aha-ai-setup-body">
      <div class="settings">
          ...
          <div class="field">
            ...
            <div class="field__item">
              <a-input
                ...
                :max-length="MAX_LENGTH_SHOP_NAME"
              />
            </div>
          </div>
        ...
        >
          ...
          <div class="field field--select-resource-checkbox">
            <div class="field__label">
...
const MAX_LENGTH_SHOP_NAME = 100
...
export default {
  ...
  computed: {
    ...
    resourcesName() {
      return this.form.excludedResourceIds.map(resource => resource.text).join(', ')
    },
