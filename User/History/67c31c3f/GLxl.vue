  ...
  >
    ...
    <div class="modal-aha-ai-setup-body">
      ...
      <div class="settings">
        ...
        <!-- Inside Settings -->
        <div class="settings__group settings__group--inside">
...
// Constants
import { DEFAULT_INPUT_MODE, IS_OPTIMAL_BOOKING_TIME_RECOMMENDATION } from 'Constant'
// APIs
...
export default {
  ...
  computed: {
    ...
    isDisabledOptimalBookingTimeRecommendation() {
      return this.form.ensureAvailableTimeSlotsWeight === TO_WEIGHT
      && this.form.prioritizeNonPeakSlotsWeight === TO_WEIGHT
      && this.form.distributeEvenlyWeight === TO_WEIGHT
    },
  },
}
</script>
