...
export const usePdfGenerator = (): IUsePdfGeneratorReturn => {
   ...
   */
  const preparePdfConfig = (sections: IPrintSection[], config?: IPdfConfig): Required<IPdfConfig> => {
   ...
   */
  const initializePdfContext = (pdf: jsPDF, config: Required<IPdfConfig>): IPdfProcessingContext => {
