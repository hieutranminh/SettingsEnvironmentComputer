...
export interface IITimezoneConvertOptions {
...
export const convertTimezone = (
  ...
  options: IITimezoneConvertOptions = {},
): dayjs.Dayjs => {
...
export const createTimezoneConverter = (
  ...
  return (date: dayjs.Dayjs | Date | string, options: ITimezoneConvertOptions = {}): dayjs.Dayjs => {
