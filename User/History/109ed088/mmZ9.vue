...
const props = withDefaults(defineProps<Props>(), {
  itemClientSummary: () => ({}) as ClientSummary,
  itemMemberSummary: () => ({}) as MemberSummary,
})
...
const transformedDataVisitingClients = computed(() => {
  if (!props.itemClientSummary) return []
...
const transformedDataVisitingMembers = computed(() => {
  if (!props.itemMemberSummary) return []
