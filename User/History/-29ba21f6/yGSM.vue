...
const createRepeatColumns = (item: NewClientsRepeatReportItem) => {
...
const formatStaffName = (staffName: string) =>
  staffName.toLowerCase() === NONE_STAFF_NAME ? t('general.label-no-input') : staffName
...
const formatYearMonthDisplay = (yearMonth: string): string => `${yearMonth.slice(0, 4)}-${yearMonth.slice(4, 6)}`
