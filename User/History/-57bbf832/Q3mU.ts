...
const transformBranchSalesData = (salesData: BranchSalesData[]): BranchSalesData[] => {
  return salesData.map((sale) => ({
    ...
    totalQuantity: sale.totalQuantity * 1000,
    totalAmount: sale.totalAmount * 1000000,
    totalDiscount: sale.totalDiscount * 1000000,
    totalTax: sale.totalTax * 1000000,
    totalNet: sale.totalNet * 1000000,
  }))
}
