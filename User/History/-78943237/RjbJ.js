...
/**
 * Check if microphone permission is granted using Permissions API
 * This avoids creating audio streams which can conflict with active speech recognition
 * @returns {Promise<boolean>} True if microphone permission is granted
 */
export async function checkMicrophonePermission() {
  // Try Permissions API first (preferred - doesn't access microphone hardware)
  ...
  // Fallback: Use getUserMedia (may conflict with active speech recognition)
