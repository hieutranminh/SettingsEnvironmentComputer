...
export function createSpeechRecognition(options) {
  ...
  if (onResult) {
    recognition.onresult = (event) => {
      ...
      // Rebuild full transcript from ALL results to avoid duplicate issues on Android/Samsung
      // Android Chrome may fire multiple events with overlapping finalTranscripts
