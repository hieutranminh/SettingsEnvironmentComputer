...
const chartPluginsCondition = computed(() => {
  // Fix TS: ensure correct type for includes and chartDisplayType
  return [CHART_DISPLAY_TYPE.BAR_LINE, CHART_DISPLAY_TYPE.BAR].includes(
    props.chartDisplayType as (typeof CHART_DISPLAY_TYPE)[keyof typeof CHART_DISPLAY_TYPE],
  )
    ? [ChartDataLabels]
    : []
})
