  ...
  computed: {
    ...
    tableRows() {
      ...
      const rows = this.sectionData.data.map(item => ({
        ...
        service:             item.servicesAmountTotal,
        product:             item.productsAmountTotal,
        revenueTotal:        item.revenueTotal,
        noOfClients:         item.numberOfSales,
        amountPerSale:       item.amountPerSale,
        prepaidCardSales:    item.prepaidCardAmountTotal,
        prepaidServiceSales: item.prepaidServicesAmountTotal,
      }))
      ...
      if (this.sectionData?.total) {
        rows.push({
          ...
          service:             this.sectionData.total.servicesAmountTotal,
          product:             this.sectionData.total.productsAmountTotal,
          ...
          prepaidCardSales:    this.sectionData.total.prepaidCardAmountTotal,
          prepaidServiceSales: this.sectionData.total.prepaidServicesAmountTotal,
        })
      }
