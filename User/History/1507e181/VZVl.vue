      ...
      >
        ...
        <ColumnGroup v-if="transformedData.length" type="footer">
          <Row>
            ...
            <Column :footer="formatAmount(mapDataTotal.newQty)" footerClass="bg-gray" />
            <Column :footer="formatAmount(mapDataTotal.newAmount)" footerClass="bg-gray" />
            <Column :footer="formatAmount(mapDataTotal.repeatQty)" footerClass="bg-gray" />
            <Column :footer="formatAmount(mapDataTotal.repeatAmount)" footerClass="bg-gray" />
            <Column :footer="formatAmount(mapDataTotal.unregisteredQty)" footerClass="bg-gray" />
            <Column :footer="formatAmount(mapDataTotal.unregisteredAmount)" footerClass="bg-gray" />
            <Column :footer="formatAmount(mapDataTotal.totalQty)" footerClass="bg-gray" />
            <Column :footer="formatAmount(mapDataTotal.totalAmount)" footerClass="bg-gray" />
          </Row>
        </ColumnGroup>
      </DataTable>
    </template>
