<template>
  <div class="actions__left">
    <!-- Search Available Times (show when IDLE mode) -->
    <a
      v-if="!isVoiceMode"
      v-b-tooltip="{ title: $t('aha-ai.search-available-times'), placement: 'bottom', delay: 1000 }"
    ...
    <!-- Animate voice (show when VOICE_LISTENING mode) -->
    <a
      v-if="isVoiceMode"
