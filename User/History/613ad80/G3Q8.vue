<template>
  <div class="actions__left">
    ...
    <a
      v-if="showAnimateVoice"
      class="action action--animate-voice"
      :class="{ 'action--animate-voice--active': isVoiceActive }"
    >
...
export default {
  ...
  computed: {
    showSearchAvailableTimes() {
      return this.mode === MODE_AI_ACTION.IDLE || this.mode === MODE_AI_ACTION.TYPING
    },
    showAnimateVoice() {
      return this.mode === MODE_AI_ACTION.VOICE_LISTENING || this.mode === MODE_AI_ACTION.VOICE_PROCESSING
    },
    isVoiceActive() {
      return this.mode === MODE_AI_ACTION.VOICE_LISTENING || this.mode === MODE_AI_ACTION.VOICE_PROCESSING
    },
