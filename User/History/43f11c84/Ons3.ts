...
import type {
  ProductSalesByItemReportRequest,
  ProductSalesByItemReportResponse,
  ProductSalesByItemReportResult,
...
export const salesReportsReadService = {
  ...
  getProductSalesByItemReport: (
    ...
    return apiRead.post<ProductSalesByItemReportResult>('sales/SalesReports/ProductSalesByItemFilterReport', request)
  },
