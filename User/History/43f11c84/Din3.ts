...
export const salesReportsReadService = {
   ...
   */
  getServiceSalesByItemReport: (request: ServiceSalesByItemReportRequest): Promise<ServiceSalesByItemReportResponse> => {
    return apiRead.post('sales/SalesReports/ServiceSalesByItemReport', request)
  },
}
