  ...
  >
    ...
    <template v-if="isCalendarReady">
      ...
      <calendar-booking-list
        ...
        :initial-search-query="bookingLookupSearchQuery"
...
export default {
  ...
  methods: {
    ...
    handleBookingLookupFromAhaAi(bookingLookupResult) {
      ...
      // Extract search query from bookingLookupResult
      // Try to get from query field, or from first item's clientName/clientMobileNumber
      const searchQuery = bookingLookupResult.query
      ...
      this.bookingLookupSearchQuery = searchQuery
      this.isBookingListModalVisible = true
    },
  },
