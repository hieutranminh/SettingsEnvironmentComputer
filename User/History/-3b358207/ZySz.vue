  ...
  >
    ...
    <template v-if="isCalendarReady">
      ...
      <calendar-booking-list
        ...
        :booking-lookup-result="bookingLookupResult"
...
export default {
  ...
  methods: {
    ...
    handleBookingLookupFromAhaAi(bookingLookupResult) {
      if(bookingLookupResult.result.items.length === 1 && bookingLookupResult.result.items[0].status !== BOOKING_STATUS.CANCELED) {
      ...
      this.bookingLookupResult = bookingLookupResult
      this.isBookingListModalVisible = true
    },
  },
