  ...
  <div>
    ...
    >
      ...
      <div class="modal-wrapper">
          ...
          <div class="section section__bottom">
            ...
            <div class="section__actions">
              <a-button
                ref="generateButton"
                v-b-tooltip="{
                  title: $t('aha-ai.tooltip-generate-ai-message'),
        ...
        <div class="modal-wrapper__right">
...
export default {
  ...
  methods: {
    onShown() {
      const textarea = this.$refs.purposeContentTextarea
    ...
    async onGenerate() {
      // Blur generate button to hide tooltip
      const generateButton = this.$refs.generateButton
      if (generateButton && generateButton.$el) {
        generateButton.$el.blur()
      }
    ...
    async onConfirmSaveMyMessage(myMessageCategoryId) {
      try {
        ...
        const determinedMessageType = this.getMessageTypeByBytes(this.currentResultItem.content)

        await textMyMessageApi.createTextMyMessageAsync({
          id:                     this.currentResultItem.id,
          contents:               this.currentResultItem.content,
          message_type:           determinedMessageType,
          shop_id:                shop_id,
