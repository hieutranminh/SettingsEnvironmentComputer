...
export const useDateRangeFilter = <T extends DateRangeFilterBase>(
  ...
  const getDateRangeForDateType = (): DateRangeValues => {
    ...
    return {
      fromDateTs: toUnixTimestamp(startOfDay, timezone, { keepLocalTime: true }),
      toDateTs: toUnixTimestamp(endOfDay, timezone, { keepLocalTime: true }),
    }
  }
  ...
  const getDateRangeForMonthType = (): DateRangeValues => {
    ...
    return {
      fromDateTs: toUnixTimestamp(startOfMonth, timezone, { keepLocalTime: true }),
      toDateTs: toUnixTimestamp(endOfMonth, timezone, { keepLocalTime: true }),
    }
  }
  ...
  const getDateRangeForRangeType = (): DateRangeValues => {
    ...
    return {
      fromDateTs: toUnixTimestamp(startDate, timezone, { keepLocalTime: true }),
      toDateTs: toUnixTimestamp(endDate, timezone, { keepLocalTime: true }),
    }
  }
