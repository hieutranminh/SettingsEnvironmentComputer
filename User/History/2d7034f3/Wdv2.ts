 ...
 * ```
 */
export const useDateRangeFilter = <T extends DateRangeFilterBase>(
  filters: Ref<T>,
  ...
  const getDateRangeForDateType = (): DateRangeValues => {
    ...
    return {
      fromDateTs: toUnixTimestamp(startOfDay, timezone as any, { keepLocalTime: true }),
      toDateTs: toUnixTimestamp(endOfDay, timezone as any, { keepLocalTime: true }),
    }
  }
  ...
  const getDateRangeForMonthType = (): DateRangeValues => {
    ...
    return {
      fromDateTs: toUnixTimestamp(startOfMonth, timezone as any, { keepLocalTime: true }),
      toDateTs: toUnixTimestamp(endOfMonth, timezone as any, { keepLocalTime: true }),
    }
  }
  ...
  const getDateRangeForRangeType = (): DateRangeValues => {
    ...
    return {
      fromDateTs: toUnixTimestamp(startDate, timezone as any, { keepLocalTime: true }),
      toDateTs: toUnixTimestamp(endDate, timezone as any, { keepLocalTime: true }),
    }
  }
