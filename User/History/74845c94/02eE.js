...
export const isSameOffDay = (offDay, calendarDate) => {
  ...
  // Convert offDay to moment with shop timezone
  // moment(offDay) handles Date objects, strings, and timestamps automatically
  const offDayMoment = moment(offDay).utcOffset(shopTimezone)
