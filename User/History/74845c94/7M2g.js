 ...
 * @param {Date} offDay - Date object representing specific off day (from timestamp)
...
export const isSameOffDay = (offDay, calendarDate) => {
  ...
  // Convert offDay to shop timezone to get correct date
  // offDay is a Date object created from timestamp stored in shop timezone
  const offDayMoment = moment(offDay.getTime()).utcOffset(shopTimezone)
