...
import { PRINT_PREVIEW_WORKER_ACTIONS, MARGIN_PRESETS } from '@/constants/print-preview.constants'
  ...
  openPreview({
    ...
    config: {
      header: {
        ...
        dateRange: { from: '2024-01-01', to: '2025-01-02' },
        showCurrentDate: true,
        showPageNumber: true,
      },
      page: {
        orientation: 'landscape',
        margins: MARGIN_PRESETS.NORMAL, // Use predefined margins
      },
      exportType: 'both',
    },
    data: [
