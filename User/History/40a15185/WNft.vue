...
const { openPreviewWithConfig } = usePrintPreview()
const { createLandscapeConfig } = usePrintConfig()

const handlePrintPreview = () => {
  const config = createLandscapeConfig('Branch Sales Report', {
    from: '2025-01-01',
    to: '2025-01-01',
  })

  openPreviewWithConfig(PRINT_PREVIEW_WORKER_ACTIONS.BRANCH_SALES, config)
}
</script>
