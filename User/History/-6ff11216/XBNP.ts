...
export interface IUseLoginHistoryReturn {
  pagination: ReturnType<typeof ref<{ totalItems: number; totalPages: number }>>
  pageSize: ReturnType<typeof ref<number>>
  loginHistoryData: ReturnType<typeof ref<ILoginHistoryItem[]>>
  filters: ReturnType<typeof ref<IFilters>>
  fetchUserList: () => Promise<void>
  fetchLoginHistory: () => Promise<void>
  setDefaultDate: () => void
  userList: ReturnType<typeof ref<IUserAccountItem[]>>
}
