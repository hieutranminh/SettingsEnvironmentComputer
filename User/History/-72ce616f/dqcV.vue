...
// Constants
import { CHART_DISPLAY_TYPE, CHART_DISPLAY_VALUE, FILTER_STATUS, type DateType, DATE_TYPE } from '@/constants'
// Types
...
const { serviceCategory, isLoading, fetchServiceCategory } = useServiceCategory()
