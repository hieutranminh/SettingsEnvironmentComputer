...
const { serviceOptions, isLoading: isServiceOptionsLoading, fetchServiceOptions } = useServiceOptions()
...
const serviceOptions = computed(() => [{ id: FILTER_VALUES.ALL, name: t('general.all') }])
