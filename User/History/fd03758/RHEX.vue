  ...
  <div class="pdf-font-demo">
      ...
      >
        ...
        >
          ...
          <span
            ...
            :class="{ available: font.isAvailable }"
          >
    ...
    <div class="font-test">
      ...
      <div class="test-buttons">
        <button
          @click="testFont('NanumGothic', 'normal')"
          class="test-btn"
        >
          Test NanumGothic Normal
        </button>
        <button
          @click="testFont('NanumGothic', 'bold')"
          class="test-btn"
        >
          Test NanumGothic Bold
        </button>
        <button
          @click="testFont('helvetica', 'normal')"
          class="test-btn"
        >
          Test Helvetica Normal
        </button>
        <button
          @click="testFont('helvetica', 'bold')"
          class="test-btn"
        >
          Test Helvetica Bold
        </button>
