...
export default {
  ...
  computed: {
    ...
    styleOptions() {
      return [
        { text: this.$t('aha-ai.style-formal'), value: 'first' },
        { text: this.$t('aha-ai.style-friendly'), value: 'second' },
        { text: this.$t('aha-ai.style-emotional'), value: 'third' },
        { text: this.$t('aha-ai.style-humorous'), value: 'fourth' },
      ]
    },
  },
