...
export default {
  ...
  computed: {
    ...
    styleOptions() {
      return [
        { text: this.$t('aha-ai.style-formal'), value: 'a' },
        { text: this.$t('aha-ai.style-friendly'), value: 'b' },
        { text: this.$t('aha-ai.style-emotional'), value: 'c' },
        { text: this.$t('aha-ai.style-humorous'), value: 'd' },
      ]
    },
  },
