<template>
  <div class="client-search-wrapper">
    ...
    <!-- Test: Swap order to check if it's position-related -->
    <b-form-radio-group
      id="radio-group-2"
      v-model="formData.toneStyle"
      :options="styleOptions"
      name="xxxxmessage-style"
    />
...
export default {
  ...
  computed: {
    ...
    styleOptions() {
      return [
        { text: 'Formal', value: 'first' },
        { text: 'Friendly', value: 'second' },
        { text: 'Emotional', value: 'third' },
        { text: 'Humorous', value: 'fourth' },
      ]
    },
  },
