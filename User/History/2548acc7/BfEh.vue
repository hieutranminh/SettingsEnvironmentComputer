      ...
      >
        ...
        <ColumnGroup v-if="transformedData.length > 1" type="footer">
          <Row>
            ...
            <Column :footer="formatAmount(lastItem?.prepaidCards?.records || 0)" footerClass="bg-gray" />
            <Column :footer="formatAmount(lastItem?.prepaidCards?.balance || 0)" footerClass="bg-gray" />
            <Column :footer="formatAmount(lastItem?.discountCards?.records || 0)" footerClass="bg-gray" />
            <Column :footer="formatAmount(lastItem?.discountCards?.balance || 0)" footerClass="bg-gray" />
            <Column :footer="formatAmount(lastItem?.prepaidServices?.records || 0)" footerClass="bg-gray" />
            <Column :footer="formatAmount(lastItem?.prepaidServices?.remainingQty || 0)" footerClass="bg-gray" />
            <Column :footer="formatAmount(lastItem?.prepaidServices?.balance || 0)" footerClass="bg-gray" />
            <Column :footer="formatAmount(lastItem?.unlimitedPrepaidServices?.records || 0)" footerClass="bg-gray" />
            ...
            <Column :footer="formatAmount(lastItem?.unlimitedPrepaidServices?.balance || 0)" footerClass="bg-gray" />
