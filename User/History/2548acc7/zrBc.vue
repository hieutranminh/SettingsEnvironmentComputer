      ...
      >
        ...
        <ColumnGroup v-if="transformedData.length" type="footer">
          <Row>
            ...
            <Column :footer="formatAmount(lastItem?.prepaidCards?.records || 0)" footerClass="bg-yellow" />
            <Column :footer="formatAmount(lastItem?.prepaidCards?.balance || 0)" footerClass="bg-yellow" />
            <Column :footer="formatAmount(lastItem?.discountCards?.records || 0)" footerClass="bg-yellow" />
            <Column :footer="formatAmount(lastItem?.discountCards?.balance || 0)" footerClass="bg-yellow" />
            <Column :footer="formatAmount(lastItem?.prepaidServices?.records || 0)" footerClass="bg-yellow" />
            <Column :footer="formatAmount(lastItem?.prepaidServices?.remainingQty || 0)" footerClass="bg-yellow" />
            <Column :footer="formatAmount(lastItem?.prepaidServices?.balance || 0)" footerClass="bg-yellow" />
            <Column :footer="formatAmount(lastItem?.unlimitedPrepaidServices?.records || 0)" footerClass="bg-yellow" />
            <Column
              :footer="formatAmount(lastItem?.unlimitedPrepaidServices?.remainingQty || 0)"
              footerClass="bg-yellow"
            />
            <Column :footer="formatAmount(lastItem?.unlimitedPrepaidServices?.balance || 0)" footerClass="bg-yellow" />
            <Column :footer="formatAmount(lastItem?.totalBalance || 0)" footerClass="bg-yellow" />
          </Row>
        </ColumnGroup>
      </DataTable>
    </template>
