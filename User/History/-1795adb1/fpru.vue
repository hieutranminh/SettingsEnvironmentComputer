          ...
          >
            ...
            >
              ...
              >
                ...
                >{{ booking.registrationDateTS | formatDateTSFromUTCToTimeZone(options.standard_date_format.ymd) }}</div>
                {{ booking.registrationDateTS }}
                <b-tooltip
...
import { getBranchNumber } from 'CommonHelpers'
