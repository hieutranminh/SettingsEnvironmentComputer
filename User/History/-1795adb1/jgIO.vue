          ...
          >
            ...
            >
              ...
              >
                ...
                >{{ booking.createdDateTimeTS | formatDateHourMin }}</div>
                <b-tooltip
                ...
                >
                  <div class="bookings__booking-date-tooltip text-left">
                    ...
                    {{ booking.registrationDateTS | formatDateTSFromUTCToTimeZone }}
                  </div>
                </b-tooltip>
              </td>
...
import { getBranchNumber, formatDateHourMin } from 'CommonHelpers'
...
export default {
  filters: {
    ...
    formatDateHourMin(value) {
      return formatDateHourMin(value, options.standard_date_format.ymd)
    },
  },
