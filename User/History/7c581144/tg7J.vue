...
// Constants
import { STANDARD_DATE_FORMAT, TIMEZONE_TYPE } from '@/constants'
// Stores
...
const dateMappedText = computed(() => {
  return `${formatDate(fromUnixTimestamp(filters.value.fromDateTs), { timezone: TIMEZONE_TYPE.UTC, format: STANDARD_DATE_FORMAT.YM })}`
})
