        ...
        <div class="filter-form">
          ...
          <div class="filter-form-group">
            <div class="filter-form-item">
              <label for="chart">{{ $t('bookings-by-source.label-chart') }}</label>
              <Select
...
import type { IBookingsBySourceFilter } from '@/types/bookings-report/BookingsBySource'
import { useDateRange } from '@/composables/useDateRange'
import { useMessageDialog } from '@/composables/useMessageDialog'

const props = defineProps<{
  modelValue: IBookingsBySourceFilter
  chartDisplayType: ChartDisplayType
}>()
const emit = defineEmits<{
  (e: 'update:modelValue', value: IBookingsBySourceFilter): void
...
const emitUpdateModelValue = (value: Partial<IBookingsBySourceFilter>): void => {
