...
export const usePrintPreviewStore = defineStore('printPreview', () => {
  ...
  // Test function to verify HTML parsing works correctly (for development only)
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const testHtmlParsing = (): void => {
    const testCases = [
      'Hello <b>bold</b> world',
      'Hello <i>italic</i> world',
      'Hello <em>emphasis</em> world',
      'Hello <b>bold</b> and <i>italic</i> world',
      'Hello <b><i>bold italic</i></b> world',
    ]

    testCases.forEach((testCase, index) => {
      const result = parseHtmlToRichText(testCase)
