...
export const route = {
  ...
  ai_setup:                        { group: 'solution', name: 'ai-setup' },
...
const router = new vue_router({
  routes: [
    ...
    {
      path:      '/admin/' + route.user_command_history.name,
      name:      route.user_command_history.name,
      component: loadPage(route.user_command_history),
      meta:      {
        preload: true,
        // permission:
      },
    ...
    {
      path:      '/admin/' + route.ai_setup.name,
      name:      route.ai_setup.name,
      component: loadPage(route.ai_setup),
      meta:      {
        preload: true,
        // permission:
      },
