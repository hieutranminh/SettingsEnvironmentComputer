...
import { convertDateToTimeStamp, formatMoney } from 'CommonHelpers'
import { mapState, mapGetters, mapActions, mapMutations } from 'vuex'
import { getDiffDateRange, getCurrentTimezoneTS, getEndOfTimezoneDateTS } from 'DatetimeHelpers'
  ...
  methods: {
    ...
    createPayload() {
      return {
        ...
        workingPeriodFromTS:                convertDateToTimeStamp(this.formAddPayrollStatement.startDate),
        workingPeriodToTS:                  convertDateToTimeStamp(this.formAddPayrollStatement.endDate),
    ...
    createSearchPayload() {
      return {
        ...
        fromDateTs:        convertDateToTimeStamp(this.formAddPayrollStatement.startDate),
        toDateTs:          convertDateToTimeStamp(this.formAddPayrollStatement.endDate),
    ...
    handleChangeFilterDateRange(value, type) {
      ...
      if (type === 'start' && value) {
        ...
        if (moment(value).isBefore(moment().startOf('month'))) {
          this.formAddPayrollStatement.endDate = moment(value).endOf('month').toDate()
        }
