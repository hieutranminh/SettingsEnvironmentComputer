      ...
      <div class="filter">
        <div class="filter-form">
          <div class="filter-form-range">
            ...
            <pre>{{ filterData }}</pre>
            <pre>{{ fromUnixTimestamp(props.modelValue.fromDateTs).toDate() }}</pre>
            <pre>{{ fromUnixTimestamp(props.modelValue.toDateTs).toDate() }}</pre>
            <div class="date-range">
              <DatePicker
                ...
                :maxDate="filterData.toDate as Date"
              ...
              <DatePicker
                ...
                :dateFormat="PRIMEVUE_DATE_FORMATS.YMD"
                :minDate="filterData.fromDate as Date"
