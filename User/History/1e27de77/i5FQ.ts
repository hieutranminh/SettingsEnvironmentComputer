...
const enforceHandlePrefixRule: Rule.RuleModule = {
  meta: {
    ...
    messages: {
      missingHandlePrefix:
        'Event handler function "{{functionName}}" should be prefixed with "handle". Suggested name: "{{suggestedName}}"',
      invalidPrefix:
        'Event handler function "{{functionName}}" should use one of the allowed prefixes: {{allowedPrefixes}}',
    },
  },
