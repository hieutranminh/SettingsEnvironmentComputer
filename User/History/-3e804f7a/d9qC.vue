<template>
  <Card>
    <template #content>
      ...
      <DataTable ref="dataTableRefPrint_01" :value="products" tableStyle="min-width: 50rem">
...
// Types
import type { BranchSalesTotalReportItem } from '@/services/sales/sales-reports/branch-sales-total-report.read'
...
const dataTableRefPrint_01 = ref()

const products = ref([
  {
    code: 'P001',
    name: 'Product 1 Product 1 Product 1 Product 1 Product 1 Product 1',
    category: 'Category 1',
    quantity: 10,
  },
  ...
  { code: 'P006', name: 'Product 6', category: 'Category 6', quantity: 60 },
  { code: 'P007', name: 'Product 7', category: 'Category 7', quantity: 70 },
  { code: 'P008', name: 'Product 8', category: 'Category 8', quantity: 80 },
  { code: 'P009', name: 'Product 9', category: 'Category 9', quantity: 90 },
  { code: 'P010', name: 'Product 10', category: 'Category 10', quantity: 100 },
  { code: 'P011', name: 'Product 11', category: 'Category 11', quantity: 110 },
  { code: 'P012', name: 'Product 12', category: 'Category 12', quantity: 120 },
  { code: 'P013', name: 'Product 13', category: 'Category 13', quantity: 130 },
  { code: 'P014', name: 'Product 14', category: 'Category 14', quantity: 140 },
  { code: 'P015', name: 'Product 15', category: 'Category 15', quantity: 150 },
  { code: 'P016', name: 'Product 16', category: 'Category 16', quantity: 160 },
  { code: 'P017', name: 'Product 17', category: 'Category 17', quantity: 170 },
])
...
const getDataTableDOM_01 = (): HTMLElement | null => {
  if (dataTableRefPrint_01.value) {
    return dataTableRefPrint_01.value.$el.querySelector('.p-datatable-table')
  }
  return null
}

const getPrintConfiguration_01 = (): PrintSection => {
  const tableElement = getDataTableDOM_01()
  if (!tableElement) {
    throw new Error('Table element not found')
  }
  return {
