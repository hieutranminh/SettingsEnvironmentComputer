<template>
  <Card>
    <template #content>
      ...
      >
        <!-- Header -->
        <BranchSalesTableHeader :columns="mainTableColumns" :headerGroups="mainTableHeaderGroups" />
      ...
      <!-- Print Table -->
      <BranchSalesPrintTable ref="printTableRef" :data="transformedData" :summaryTotals="summaryTotals" />
...
import { BRANCH_SALES_TABLE_CONFIG, MAIN_TABLE_COLUMNS, MAIN_TABLE_HEADER_GROUPS } from '@/constants/branchSalesTable'
// Types
