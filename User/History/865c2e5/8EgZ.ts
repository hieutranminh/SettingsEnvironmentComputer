...
export const PDF_TEXT_ALIGNMENT = {
  ...
  DEFAULT_HORIZONTAL: 'left' as const,
  DEFAULT_VERTICAL: 'middle' as const,
} as const
...
/**
 * PDF date and time formatting constants
 */
export const PDF_DATE_FORMATS = {
  // Standard date format for PDF headers
  HEADER_DATE: 'YYYY-MM-DD (ddd)' as const,
  
  // Alternative formats for different contexts
  SHORT_DATE: 'YYYY-MM-DD' as const,
  LONG_DATE: 'YYYY년 MM월 DD일 (dddd)' as const,
  ISO_DATE: 'YYYY-MM-DDTHH:mm:ss' as const,
} as const
