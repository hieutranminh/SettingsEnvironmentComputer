...
const handleDisplayAmount = (amount: number): string => {
  const { prepaidSalesCountingType } = props
  console.log('prepaidSalesCountingType', prepaidSalesCountingType)

  if (prepaidSalesCountingType === PREPAID_SALES_COUNTING_TYPE.USED) return '-'
