    ...
    createExcelCustomHandler() {
      return (ws) => {
        ...
        const mergeCellRanges = [
          ...
          `F${row1Num}:G${row1Num}`, // Late Cancellation (colspan=2)
        ...
        headerRow2.eachCell((cell, colNumber) => {
          if (colNumber > 1) { // Skip first cell (merged with row 1)
