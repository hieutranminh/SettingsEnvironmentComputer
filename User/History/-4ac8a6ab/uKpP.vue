<template>
  <div class="section-booking">
    ...
    >
      <booking-chart-bookings :section-data="sectionData" />
      <booking-chart-cancellation :section-data="sectionData" />
    </div>
...
import BookingChartBookings from './booking-chart-bookings.vue'
import BookingChartCancellation from './booking-chart-cancellation.vue'
import BookingTable from './booking-table.vue'
// Mixins
...
export default {
  ...
  components: {
    ReportAiSummary,
    BookingChartBookings,
    BookingChartCancellation,
    BookingTable,
  },
