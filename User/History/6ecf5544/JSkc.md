...
<Select :loading="isLoadingBranchTypes" :disabled="isLoadingBranchTypes" @change="handleFilterChange" />
<small v-if="branchTypesError" class="error-message">
  {{ branchTypesError }}
</small>

<!-- ✅ ADDED: Reset functionality -->
<Button type="button" label="Reset" severity="secondary" variant="outlined" @click="handleReset" />
```
