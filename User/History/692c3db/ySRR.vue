<template>
  <div class="section-overall-revenue">
    ...
    <!-- Hidden print section: same charts but without dropdown, synced with above -->
    <div
      ref="chartsSection"
    ...
    >
      <overall-revenue-chart
        :section-data="sectionData"
        :display-item="leftChartDisplayItem"
        hide-display-item
      />
      <overall-revenue-chart
        :section-data="sectionData"
        :display-item="rightChartDisplayItem"
        hide-display-item
      />
    </div>
  ...
  methods: {
    ...
    getPrintSections() {
      ...
      if (this.$refs.chartsSection) {
        console.log('this.$refs.chartsSection', this.$refs.chartsSection)
        sections.push({
          ref_type:    print_options.print_ref_type.canvas,
