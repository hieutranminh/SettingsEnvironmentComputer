  ...
  <div class="section-overall-revenue">
    ...
    >
      <div class="chart-print-item">
        <div class="chart-print-title">{{ leftChartLabel }}</div>
        <chart-line
          v-if="hasChartData"
          :data="leftChartData"
          :is_decimal="true"
      ...
      <div class="chart-print-item">
        <div class="chart-print-title">{{ rightChartLabel }}</div>
        <chart-line
          v-if="hasChartData"
          :data="rightChartData"
          :is_decimal="true"
...
export default {
  ...
  methods: {
    ...
    getPrintSections() {
      ...
      // Left Chart as CANVAS (excludes dropdown via printContent ref)
      if (this.$refs.leftChart?.$refs.printContent) {
        sections.push({
          ref_type:    print_options.print_ref_type.canvas,
          section_ref: this.$refs.leftChart.$refs.printContent,
        })
      }

      // Right Chart as CANVAS (excludes dropdown via printContent ref)
      if (this.$refs.rightChart?.$refs.printContent) {
        sections.push({
          ref_type:    print_options.print_ref_type.canvas,
          section_ref: this.$refs.rightChart.$refs.printContent,
        })
      }
