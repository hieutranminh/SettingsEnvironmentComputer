...
export default {
  ...
  computed: {
    ...
    tableCustomStyles() {
      return [
        { halign: 'left' },   // Month
        { halign: 'right' },  // Service
        { halign: 'right' },  // Product
        { halign: 'right' },  // Revenue Total
        { halign: 'right' },  // No. of Clients
        { halign: 'right' },  // Amount per Sale
        { halign: 'right' },  // Prepaid Card
        { halign: 'right' },  // Prepaid Service
      ]
    },
