...
const now = new Date()
console.log('Current date (English):', formatDate(now, { locale: 'en' }))
console.log('Current date (Korean):', formatDate(now, { locale: 'ko' }))
console.log('Current datetime (English):', formatDate(now, { format: 'datetime', locale: 'en' }))
console.log('Current datetime (Korean):', formatDate(now, { format: 'datetime', locale: 'ko' }))

// 2. Relative time formatting
const yesterday = subtractTime(now, 1, 'day')
console.log('Yesterday (English):', formatRelativeTime(yesterday, { locale: 'en' }))
console.log('Yesterday (Korean):', formatRelativeTime(yesterday, { locale: 'ko' }))
...
console.log('Month name (English):', getMonthName(now, 'en'))
console.log('Month name (Korean):', getMonthName(now, 'ko'))
console.log('Day name (English):', getDayName(now, 'en'))
console.log('Day name (Korean):', getDayName(now, 'ko'))
