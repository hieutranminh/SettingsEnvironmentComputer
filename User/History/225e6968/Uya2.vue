    ...
    <template #content>
      ...
      >
        ...
        <Column field="prepaidCardAmount">
          <template #body="{ data }">
            {{ handleDisplayPrepaidCardAmount(data.prepaidCardAmount) }}
          </template>
        </Column>
        <Column field="prepaidServiceAmount">
          <template #body="{ data }">
            {{ handleDisplayPrepaidServiceAmount(data.prepaidServiceAmount) }}
          </template>
        </Column>
        <Column field="total">
          <template #body="slotProps">
...
const handleDisplayPrepaidCardAmount = (amount: number): string => {
...
const handleDisplayPrepaidServiceAmount = (amount: number): string => {
  const { prepaidSalesCountingType } = props
