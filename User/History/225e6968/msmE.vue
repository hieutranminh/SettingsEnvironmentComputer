      ...
      >
        ...
        <ColumnGroup type="footer">
          <Row>
            ...
            <Column :footer="formatAmount(mapDataTotal.serviceAmount)" footerClass="bg-gray" />
            <Column :footer="formatAmount(mapDataTotal.productAmount)" footerClass="bg-gray" />
            <Column :footer="formatAmount(mapDataTotal.prepaidCardAmount)" footerClass="bg-gray" />
            <Column :footer="formatAmount(mapDataTotal.prepaidServiceAmount)" footerClass="bg-gray" />
            <Column :footer="formatAmount(mapDataTotal.total)" footerClass="bg-gray" />
          </Row>
        </ColumnGroup>
      </DataTable>
    </template>
