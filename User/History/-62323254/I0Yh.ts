...
export const menu_data: MenuStructure = {
  branch: {
  ...
  account: {
    ...
    submenu: {
      ...
      shop_information: {
        text: 'shop-information', //가입자정보
        link: '/account/shop-information',
        code: 'SHQ_ACC_03',
      },
    },
  },
...
export const FILTER_OPTIONS = {
  ALL: { id: FILTER_VALUES.ALL, name: 'All' },
  NONE: { id: FILTER_VALUES.NONE, name: 'None' },
} as const

// Filter comparison helpers
export const FILTER_HELPERS = {
  isAll: (value: number): boolean => value === FILTER_VALUES.ALL,
  isNotAll: (value: number): boolean => value !== FILTER_VALUES.ALL,
  isAllSelected: (filters: number[]): boolean => filters.length === 0,
} as const
