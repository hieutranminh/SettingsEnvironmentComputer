...
export const REPORT_BY_TYPE_IN_CLIENTS_BY_TYPE = {
  SEX: 1,
  CLIENT_RATING: 2,
  CLIENT_GROUP: 3,
} as const

export type ReportByTypeInClientsByType =
  (typeof REPORT_BY_TYPE_IN_CLIENTS_BY_TYPE)[keyof typeof REPORT_BY_TYPE_IN_CLIENTS_BY_TYPE]
