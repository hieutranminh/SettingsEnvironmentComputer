...
export const TABLE_SPAN_CONFIG = {
  VISITING_CLIENTS: {
    COUNTING_BASIS_ROWSPAN: 2,
    REGISTERED_CLIENTS_COLSPAN: 3,
    UNREGISTERED_CLIENTS_ROWSPAN: 2,
    GRAND_TOTAL_ROWSPAN: 2,
  },
  VISITING_MEMBERS: {
    COUNTING_BASIS_ROWSPAN: 2,
    PREPAID_SALES_COLSPAN: 3,
    PREPAID_DEDUCTION_ROWSPAN: 2,
  },
} as const
