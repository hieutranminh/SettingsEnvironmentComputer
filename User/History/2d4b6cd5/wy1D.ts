...
const createComputedProperties = (formState: Ref<FormState>) => {
...
const createFormActions = (formState: Ref<FormState>) => {
...
export const usePrimeVueForm = () => {
  ...
  const actions = createFormActions(formState)
  const computedProps = createComputedProperties(formState)
