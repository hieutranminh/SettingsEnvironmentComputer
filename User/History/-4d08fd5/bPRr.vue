          ...
          <div class="filter-form-group">
            ...
            <div class="filter-form-item">
              <div class="filter-form-radio-item">
                <RadioButton v-model="prepaidSalesCountingModel" inputId="when-sold" name="when-sold" />
                <label for="qty">{{ $t('service-sales.label-qty') }}</label>
              </div>
              <div class="filter-form-radio-item">
                <RadioButton v-model="prepaidSalesCountingModel" inputId="when-used" name="when-used" />
                <label for="amount">{{ $t('service-sales.label-amount') }}</label>
              </div>
            </div>
          </div>
        </div>
...
const props = defineProps<{
  ...
  chartDisplayType: number
}>()

const emit = defineEmits<{
  (e: 'update:modelValue', value: ServiceSalesFilterInterface): void
  (e: 'chartDisplayTypeChanged', value: number): void
}>()
...
const chartDisplayTypeOptions = computed(() => [
  { id: CHART_TYPE.BAR, name: t('general.label-chart-bar') },
  { id: CHART_TYPE.PIE, name: t('general.label-chart-pie') },
])
...
const handlechartDisplayTypeChange = (value: number) => {
