...
// Utils
import { getAiSummaryPlainText } from 'Modules/reports/report-ai-summary/report-ai-summary-utils'
// Mixins
...
export default {
  ...
  computed: {
    ...
    tableCustomStyles() {
      // First column (Month) is center, staff columns are right-aligned
