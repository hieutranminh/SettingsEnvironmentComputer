...
const handleFromMonthChange = (value: DateValue) => {
...
const handleToMonthChange = (value: DateValue) => {
  if (!isValidDate(value)) return

  const endOfUnit = getEndOf(value, 'day')
  console.log('0', endOfUnit)
  console.log('1', toUnixTimestamp(endOfUnit.toDate()))
  console.log('2', toUnixTimestamp(endOfUnit.toDate(), TIMEZONE_TYPE.UTC, { keepLocalTime: true }))
  emitUpdateModelValue({
