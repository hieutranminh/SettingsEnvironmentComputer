...
const actions = {
   ...
   */
  async openBookingActionBySlot({ rootState, dispatch }, {
    date,
    startTime,
    resource,
    client,
    ...
    console.log('1', date, startTime, resource, client, isWalking, estimatedTime)
    ...
    bookedResource.estimatedTime = estimatedTime ? estimatedTime : rootState._calendar.timeSlot
    ...
    booking.bookingDateTS = convertDateToMomentUTC(date).startOf('day').unix()
