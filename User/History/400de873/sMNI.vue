        ...
        <div class="filter-form">
          ...
          <div class="filter-form-counting">
            <label for="prepaid-sales-counting">
              {{ $t('service-sales-by-month.prepaid-sales-counting') }}
              <TooltipWithIconQuestion :tooltip="$t('service-sales-by-month.tooltip-prepaid-sales-counting')" />
            </label>
            ...
            <div class="filter-form-radio">
              <div class="filter-form-radio-item">
                ...
                />
                <label for="when-sold">{{ $t('service-sales-by-month.label-when-sold') }}</label>
              </div>
              <div class="filter-form-radio-item">
                <RadioButton
                  v-model="prepaidSalesCountingModel"
                ...
                />
                <label for="when-used">{{ $t('service-sales-by-month.label-when-used') }}</label>
              </div>
            </div>
          </div>
        </div>
