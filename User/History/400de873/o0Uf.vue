          ...
          <div class="filter-form-group">
            ...
            <div class="filter-form-item">
              ...
              <Select
                ...
                :ariaLabel="$t('service-sales-by-item.label-category')"
                labelId="category"
                optionLabel="name"
                optionValue="id"
            ...
            <div class="filter-form-item">
              ...
              <Select
                ...
                :ariaLabel="$t('service-sales-by-item.label-service')"
                labelId="service"
                optionLabel="name"
                optionValue="id"
              />
            ...
            <div class="filter-form-item">
              ...
              <Select
                ...
                :ariaLabel="$t('service-sales-by-item.label-chart')"
                labelId="chart"
                optionLabel="name"
                optionValue="id"
...
const serviceCategoryOptions = computed(() => createSelectOptions({
  ...
  serviceCategory.value.map((item) => ({
    ...
    const serviceOptions = computed(() => createSelectOptions({
  { id: FILTER_VALUES.ALL, name: t('general.all') },
...
const handleChartDisplayValueChange = (value: ChartDisplayValue) => {
