...
const getSelectedPrepaidGoodsTypes = (reportByType: number): number[] => {
  const typeMapping: Record<number, number[]> = {
    ...
    [REPORT_BY_TYPE_IN_PREPAID_GOODS_REPURCHASE.SERVICE]: [REPORT_BY_TYPE_IN_PREPAID_GOODS_REPURCHASE.SERVICE],
    [REPORT_BY_TYPE_IN_PREPAID_GOODS_REPURCHASE.CARD]: [REPORT_BY_TYPE_IN_PREPAID_GOODS_REPURCHASE.CARD],
  }
