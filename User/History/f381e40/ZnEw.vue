          ...
          <div class="filter-form-group">
            <div class="filter-form-item">
              <div class="filter-form-checkbox">
                <pre>{{ prepaidGoods }}</pre>
                <Checkbox
                  v-model="prepaidGoods"
...
watch(
  prepaidGoods,
  (newPrepaidGoods) => {
    if (props.modelValue.reportByType === REPORT_BY_TYPE_IN_PREPAID_GOODS_REPURCHASE.NONE) {
      prepaidGoods.value = []
    }
    if (props.modelValue.reportByType === REPORT_BY_TYPE_IN_PREPAID_GOODS_REPURCHASE.ALL) {
      prepaidGoods.value = [
        REPORT_BY_TYPE_IN_PREPAID_GOODS_REPURCHASE.CARD,
        REPORT_BY_TYPE_IN_PREPAID_GOODS_REPURCHASE.SERVICE,
      ]
    }
    if (props.modelValue.reportByType === REPORT_BY_TYPE_IN_PREPAID_GOODS_REPURCHASE.SERVICE) {
      prepaidGoods.value = [REPORT_BY_TYPE_IN_PREPAID_GOODS_REPURCHASE.SERVICE]
    }
    if (props.modelValue.reportByType === REPORT_BY_TYPE_IN_PREPAID_GOODS_REPURCHASE.CARD) {
      prepaidGoods.value = [REPORT_BY_TYPE_IN_PREPAID_GOODS_REPURCHASE.CARD]
    }
    console.log('newPrepaidGoods', newPrepaidGoods)
  },
  { immediate: true },
)
