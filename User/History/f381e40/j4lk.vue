            ...
            <div class="filter-form-item">
              <div class="filter-form-checkbox">
                <Checkbox
                  ...
                  binary
                  :modelValue="
                    modelValue.reportByType === REPORT_BY_TYPE_IN_PREPAID_GOODS_REPURCHASE.ALL ||
                    modelValue.reportByType === REPORT_BY_TYPE_IN_PREPAID_GOODS_REPURCHASE.CARD
                  "
                  :ariaLabel="$t('prepaid-goods-repurchase.label-prepaid-card')"
                  @update:modelValue="toggleCardCheckbox"
                />
              ...
              <div class="filter-form-checkbox">
                <Checkbox
                  ...
                  :modelValue="
                    modelValue.reportByType === REPORT_BY_TYPE_IN_PREPAID_GOODS_REPURCHASE.ALL ||
                    modelValue.reportByType === REPORT_BY_TYPE_IN_PREPAID_GOODS_REPURCHASE.SERVICE
                  "
                  :ariaLabel="$t('prepaid-goods-repurchase.label-prepaid-service')"
                  @update:modelValue="toggleServiceCheckbox"
                />
...
const toggleCardCheckbox = (value: boolean) => {
  let reportByType = REPORT_BY_TYPE_IN_PREPAID_GOODS_REPURCHASE.NONE
  if (value && props.modelValue.reportByType === REPORT_BY_TYPE_IN_PREPAID_GOODS_REPURCHASE.ALL) {
    reportByType = REPORT_BY_TYPE_IN_PREPAID_GOODS_REPURCHASE.CARD
  } else if (value && props.modelValue.reportByType === REPORT_BY_TYPE_IN_PREPAID_GOODS_REPURCHASE.SERVICE) {
    reportByType = REPORT_BY_TYPE_IN_PREPAID_GOODS_REPURCHASE.SERVICE
  } else if (value && props.modelValue.reportByType === REPORT_BY_TYPE_IN_PREPAID_GOODS_REPURCHASE.NONE) {
    reportByType = REPORT_BY_TYPE_IN_PREPAID_GOODS_REPURCHASE.NONE
  } else if (value && props.modelValue.reportByType === REPORT_BY_TYPE_IN_PREPAID_GOODS_REPURCHASE.ALL) {
  }
}

const toggleServiceCheckbox = (value: boolean) => {
  console.log('toggleServiceCheckbox', value)
}
