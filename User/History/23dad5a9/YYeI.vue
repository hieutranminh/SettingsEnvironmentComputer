...
export default {
  ...
  methods: {
    ...
    async onSelectAvailableTime(resource, slot) {
      ...
      console.log('isSearchAvailableTimesFromBookingItems', this.isSearchAvailableTimesFromBookingItems)
      console.log('selectedBookedResource', this.selectedBookedResource)
      if (this.isSearchAvailableTimesFromBookingItems && this.selectedBookedResource) {
        if (bookingActionModal) {
          ...
          // Add booked items to selected booked resource
          await this.addBookedItemsToSelectedBookedResource()
        } else {
    ...
    async addBookedItemsToSelectedBookedResource() {
      if (!this.searchAvailableTimesItemsData) {
        return
      }
      ...
      // Use selectedBookedResource for updating existing booking
