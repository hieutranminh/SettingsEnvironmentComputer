  ...
  methods: {
    ...
    async onSelectAvailableTime(resource, slot) {
      ...
      if (this.isSearchAvailableTimesFromBookingItems && this.selectedBookedResource) {
        ...
        console.log('searchAvailableTimesItemsData', this.searchAvailableTimesItemsData)
    ...
    async addBookedItemsFromSearchAvailableTimes() {
      console.log('addBookedItemsFromSearchAvailableTimes', this.searchAvailableTimesItemsData)
