  ...
  rules: {
    ...
    '@typescript-eslint/naming-convention': [
      'error',
      {
        selector: 'function',
        format: ['camelCase'],
        // Các hàm trong Vue script setup phải có tiền tố "handle"
        filter: {
          regex: '^(handle|use|get|set|is|has|can|should|will|did|on|off|add|remove|update|delete|create|find|search|filter|map|reduce|forEach|some|every|includes|indexOf|lastIndexOf|slice|splice|push|pop|shift|unshift|sort|reverse|join|split|replace|match|test|exec|toString|valueOf|toLocaleString|toJSON|toFixed|toPrecision|toExponential|parseInt|parseFloat|isNaN|isFinite|escape|unescape|encodeURI|encodeURIComponent|decodeURI|decodeURIComponent|btoa|atob|setTimeout|setInterval|clearTimeout|clearInterval|requestAnimationFrame|cancelAnimationFrame|addEventListener|removeEventListener|dispatchEvent|preventDefault|stopPropagation|stopImmediatePropagation|getAttribute|setAttribute|removeAttribute|hasAttribute|getAttributeNode|setAttributeNode|removeAttributeNode|hasAttributeNode|getElementsByTagName|getElementsByClassName|getElementById|querySelector|querySelectorAll|createElement|createTextNode|createDocumentFragment|createComment|createCDATASection|createProcessingInstruction|createEntityReference|importNode|adoptNode|normalize|isSupported|hasChildNodes|cloneNode|insertBefore|replaceChild|removeChild|appendChild|hasAttributes|getAttributeNames|getBoundingClientRect|getClientRects|scrollIntoView|scrollIntoViewIfNeeded|scroll|scrollTo|scrollBy|getComputedStyle|matches|closest|contains|compareDocumentPosition|isSameNode|isEqualNode|lookupPrefix|lookupNamespaceURI|isDefaultNamespace|insertAdjacentElement|insertAdjacentHTML|insertAdjacentText|remove|before|after|replaceWith|prepend|append|animate|getAnimations|computedStyleMap|attributeStyleMap|getAttribute|setAttribute|removeAttribute|hasAttribute|getAttributeNode|setAttributeNode|removeAttributeNode|hasAttributeNode|getElementsByTagName|getElementsByClassName|getElementById|querySelector|querySelectorAll|createElement|createTextNode|createDocumentFragment|createComment|createCDATASection|createProcessingInstruction|createEntityReference|importNode|adoptNode|normalize|isSupported|hasChildNodes|cloneNode|insertBefore|replaceChild|removeChild|appendChild|hasAttributes|getAttributeNames|getBoundingClientRect|getClientRects|scrollIntoView|scrollIntoViewIfNeeded|scroll|scrollTo|scrollBy|getComputedStyle|matches|closest|contains|compareDocumentPosition|isSameNode|isEqualNode|lookupPrefix|lookupNamespaceURI|isDefaultNamespace|insertAdjacentElement|insertAdjacentHTML|insertAdjacentText|remove|before|after|replaceWith|prepend|append|animate|getAnimations|computedStyleMap|attributeStyleMap)',
          match: false,
        },
      },
      {
