...
module.exports = {
  ...
  rules: {
    ...
    '@typescript-eslint/explicit-method-return-type': 'error', // Bắt buộc return type cho methods

    /* ===== TypeScript Function Return Types ===== */
    '@typescript-eslint/prefer-function-type': 'error', // Ưu tiên function type syntax
    ...
    '@typescript-eslint/typedef': [
      'error',
      {
        ...
        variableDeclaration: false, // Tắt cho let/const declarations
        variableDeclarationIgnoreFunction: true, // Bỏ qua function declarations
      },
    ],
    /* ===== Vue rules ===== */
