...
module.exports = {
  ...
  extends: [
    'eslint:recommended', // Bộ rule ESLint cơ bản, bắt những lỗi JS phổ biến:contentReference[oaicite:2]{index=2}
    'plugin:vue/vue3-recommended', // Bộ rule khuyến nghị cho Vue 3 (style guide Priority A, B, C):contentReference[oaicite:3]{index=3}:contentReference[oaicite:4]{index=4}
    'plugin:@typescript-eslint/recommended', // Bộ rule khuyến nghị cho TypeScript
    // 'plugin:@typescript-eslint/recommended-requiring-type-checking',
    // ↑ (Tùy chọn nâng cao: bộ rule nghiêm ngặt hơn, yêu cầu type-check, giúp bắt lỗi logic TS phức tạp)
    'prettier', // Đặt cuối cùng để vô hiệu hóa các rule xung đột với Prettier:contentReference[oaicite:5]{index=5}
  ],
  plugins: [
    'vue',
    '@typescript-eslint',
  ...
  rules: {
    ...
    'no-console': 'warn', // có thể chuyển 'error' trong CI/prod
    'no-debugger': 'error',
    eqeqeq: 'error',
    ...
    '@typescript-eslint/no-explicit-any': 'warn', // cân nhắc nâng lên 'error' nếu team muốn nghiêm ngặt
