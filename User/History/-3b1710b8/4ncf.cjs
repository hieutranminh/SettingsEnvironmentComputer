...
module.exports = {
  ...
  rules: {
    ...
    '@typescript-eslint/explicit-function-return-type': [
      'error',
      {
        allowExpressions: true, // Bắt buộc arrow function cũng phải khai báo return type
    ...
    // Custom rule để bắt buộc "handle" prefix cho functions trong Vue script setup
    'vue-handle-prefix': 'error',
    /* ===== Vue rules khác ===== */
