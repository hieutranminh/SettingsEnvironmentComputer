...
export default {
  ...
  data() {
    const initialTimestamp = this.isPeriodSelection ? this.fromDateTs : this.bookingDates?.[0]
    return {
      datePickerKey: 0,
      currentPage:   this.getPageFromTimestamp(initialTimestamp),
    }
  },
  ...
  methods: {
    getPageFromTimestamp(timestamp) {
