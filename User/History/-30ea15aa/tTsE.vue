...
export default {
  ...
  computed: {
    ...
    disabledDates() {
      // Return localDisabledDates if available, otherwise compute default
      if (this.localDisabledDates !== null) {
        return this.localDisabledDates
      }
