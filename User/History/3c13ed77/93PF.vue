    ...
    <ColumnGroup type="header">
      <Row>
        ...
        <Column :rowspan="2" headerClass="bg-yellow">
          <template #header>
            <p>
              {{ $t('branch-sales.label-revenue-total') }} <br />(<span class="text-no-wrap">{{
                $t('branch-sales.label-a-b')
              }}</span
              >)
            </p>
          </template>
        ...
        <Column :rowspan="2" headerClass="bg-green">
          <template #header>
            <p>
              ...
              (<span class="text-blue text-no-wrap">{{ $t('branch-sales.label-s1-s2-s3-s4') }}</span
              >)
            </p>
          </template>
        </Column>
