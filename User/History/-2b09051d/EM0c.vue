...
export default {
  ...
  methods: {
     ...
     * @param {Event} event - The composition event
     * @param {number} indexArea - The index of the content area
     */
    handleContentCompositionEnd (event, indexArea) {
      this.isComposing = false
      this.checkContentLength(event.target.value, indexArea, event.target)
    },
     ...
     * @param {number} indexArea - The index of the content area
     */
    handleContentInput (event, indexArea) {
      if (this.isComposing) {
        return
      }
      ...
      this.checkContentLength(value, indexArea, textarea)
    },
     ...
     */
    checkContentLength (value, indexArea, textarea) {
