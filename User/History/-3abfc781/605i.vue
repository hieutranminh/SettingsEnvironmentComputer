  ...
  <div class="print-example">
    ...
    <div class="example-section">
      ...
      <div class="table-preview">
        ...
        <DataTable :value="tableData" :columns="tableColumns" stripedRows>
          <Column
    ...
    <div class="example-section">
      ...
      <div class="chart-preview" ref="chartRef">
        <h4>Sample Chart</h4>
        <div class="chart-placeholder">
          <i class="pi pi-chart-bar" style="font-size: 4rem; color: var(--primary-color)"></i>
      ...
      <div class="mixed-preview">
        ...
        <div class="mixed-content">
          ...
          <div class="table-section">
            <h5>Table Section</h5>
            <DataTable :value="mixedTableData" :columns="mixedTableColumns" stripedRows>
              <Column
