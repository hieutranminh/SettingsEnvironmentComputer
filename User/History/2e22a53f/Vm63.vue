...
export default {
  ...
  methods: {
    ...
    onConfirmSearchAvailableTimes() {
      // Include selected relative match items for estimatedTime calculation
      const selectedItems = {
        selectedServiceItems: Object.values(this.selectedServiceItems),
        selectedBookingItems: Object.values(this.selectedBookingItems),
      }
      this.$emit('confirm-search-available-times', this.searchAvailableTimesData, selectedItems)
      this.$refs.modalAhaAi.hide()
    },
  },
