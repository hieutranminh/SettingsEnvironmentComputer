 ...
 */
export const MAIN_TABLE_COLUMNS: ColumnConfig[] = [
  // Service columns
  {
    field: 'serviceSales',
 ...
 */
export const PRINT_TABLE_COLUMNS: ColumnConfig[] = [
  // Service columns
  {
    field: 'serviceSales',
    headerKey: 'branch-sales.label-sales',
 ...
 */
export const MAIN_TABLE_HEADER_GROUPS: HeaderGroupConfig[] = [
  {
 ...
 */
export const PRINT_TABLE_HEADER_GROUPS: HeaderGroupConfig[] = [
  {
    label: 'branch-sales.label-service',
    suffix: '(A)',
    colspan: 3,
