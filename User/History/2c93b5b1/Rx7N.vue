...
// Types
import type { ISalesByDiscountCategoryFilterInterface } from '@/types/sales-report/SalesByDiscountCategory'
// Utils
import {
  fromUnixTimestamp,
...
const props = defineProps<{
  modelValue: ISalesByDiscountCategoryFilterInterface
}>()

const emit = defineEmits<{
  (e: 'update:modelValue', value: ISalesByDiscountCategoryFilterInterface): void
...
const emitUpdateModelValue = (value: Partial<ISalesByDiscountCategoryFilterInterface>): void => {
