        ...
        <div class="filter-form">
          ...
          <div class="filter-form-group">
            <div class="filter-form-item">
              <label for="chart">{{ $t('bookings-by-day-of-week.label-chart') }}</label>
              <Select
...
import type { IBookingsByDayOfWeekFilter } from '@/types/bookings-report/BookingsByDayOfWeek'
import { useMessageDialog } from '@/composables/useMessageDialog'
import { useDateRange } from '@/composables/useDateRange'
const props = defineProps<{
  modelValue: IBookingsByDayOfWeekFilter
  chartDisplayType: ChartDisplayType
}>()
const emit = defineEmits<{
  (e: 'update:modelValue', value: IBookingsByDayOfWeekFilter): void
...
const emitUpdateModelValue = (value: Partial<IBookingsByDayOfWeekFilter>): void => {
