...
const ensurePageHeader = (
  ...
  if (currentPageNumber > PAGE_NUMBERING.FIRST_PAGE_NUMBER && 
      !context.pagesWithHeaders.has(currentPageNumber)) {
...
const getValidAlignment = (alignment?: string): TextAlignment => {
  ...
  return validAlignments.includes(alignment as TextAlignment) 
