...
export const DEFAULT_PRINT_CONFIG = {
  ...
  // Default margins (pt) - Adjusted for jsPDF
  MARGINS: {
    TOP: 20, // Reduced for better positioning
    BOTTOM: 20, // Reduced for better positioning
    LEFT: 20, // Reduced for better positioning
    RIGHT: 20, // Reduced for better positioning
  },
...
// Helper function to create custom margins
export const createMargins = (top = 20, bottom = 20, left = 20, right = 20) => ({
  top,
  bottom,
  left,
  right,
...
export const MARGIN_PRESETS = {
  TIGHT: createMargins(10, 10, 10, 10),
  NORMAL: createMargins(20, 20, 20, 20),
  WIDE: createMargins(36, 36, 36, 36),
  PRINT_FRIENDLY: createMargins(15, 15, 15, 15),
} as const
