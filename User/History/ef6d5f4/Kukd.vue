    ...
    <div class="info-section">
      ...
      <div class="info-grid">
        <div class="info-item full-width">
          ...
          <code class="info-code">{{ info.apiBaseUrl }}</code>
        </div>
        <div class="info-item">
    ...
    <div class="info-section">
      ...
      <div class="feature-flags">
        <div v-for="setting in getBuildSettings()" :key="setting.name" class="feature-flag">
          ...
          <Tag
            :value="setting.value"
            :severity="setting.enabled ? 'success' : 'secondary'"
          />
        </div>
      </div>
    </div>
    ...
    <div class="info-section">
      ...
      <div class="info-grid">
        ...
        <div class="info-item">
          ...
          <Tag
            :value="info.hasSentryDsn ? 'Configured' : 'Not configured'"
            :severity="info.hasSentryDsn ? 'success' : 'secondary'"
          />
        </div>
        <div class="info-item">
          <span class="info-label">Google Analytics</span>
          <Tag
            :value="info.hasGaTrackingId ? 'Configured' : 'Not configured'"
            :severity="info.hasGaTrackingId ? 'success' : 'secondary'"
          />
        </div>
      </div>
    </div>
    ...
    <div class="info-section">
      ...
      <div class="env-flags">
        <div class="env-flag">
          ...
          <Tag :value="String(info.isDevelopment)" :severity="info.isDevelopment ? 'info' : 'secondary'" />
        </div>
        <div class="env-flag">
          <span>isProduction</span>
          <Tag :value="String(info.isProduction)" :severity="info.isProduction ? 'success' : 'secondary'" />
        </div>
        <div class="env-flag">
          <span>isLocalhost</span>
          <Tag :value="String(info.isLocalhost)" :severity="info.isLocalhost ? 'info' : 'secondary'" />
        </div>
        <div class="env-flag">
          <span>isStaging</span>
