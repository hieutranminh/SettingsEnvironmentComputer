...
// Types
import type { IBranchPrepaidGoodsFilter } from '@/types/branch/BranchPrepaidGoodsFilter'
...
const handleFiltersChanged = async (newFilters: IBranchPrepaidGoodsFilter): Promise<void> => {
