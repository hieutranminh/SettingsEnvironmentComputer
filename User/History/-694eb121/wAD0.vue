  ...
  >
    ...
    <div class="modal-aha-ai-body">
      ...
      >
        ...
        <!-- Service Items -->
        <p
          v-for="serviceItem in exactMatchServiceItems"
          :key="`service-${serviceItem.serviceId}`"
        >
          {{ $t('aha-ai.message-found', { itemName: serviceItem.serviceName }) }}
        </p>
        <!-- Booking Items -->
        <p
          v-for="bookingItem in exactMatchBookingItems"
          :key="`booking-${bookingItem.id}`"
        >
          {{ $t('aha-ai.message-found', { itemName: bookingItem.bookingItemName }) }}
        </p>

        <!-- ======= RELATIVE MATCH DISPLAY ======= -->
        <!-- Service Items -->
...
export default {
  ...
  methods: {
    ...
    onConfirm() {
      ...
      this.$emit('booked-items-add', bookedItems)
      this.$refs.modalAhaAi.hide()
    },
    ...
    handleResultFromAhaAi(result) {
      ...
      console.log('hasRelativeMatchResult', this.hasRelativeMatchResult)
