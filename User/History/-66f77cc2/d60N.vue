    ...
    return {
      ...
      table_data: {
        fields: [
          ...
          { field: 'subscriber_number', label: 'user-command-history.label-subscriber-number', width: '10%' },
          { field: 'subscriber_name', label: 'user-command-history.label-subscriber-name', width: '10%' },
          { field: 'business_type_code', label: 'user-command-history.label-business-type', width: '10%' },
          { field: 'function_type', label: 'user-command-history.label-function', width: '10%' },
          { field: 'command', label: 'user-command-history.label-command', width: '30%' },
          { field: 'failure_code', label: 'user-command-history.label-failure-code', width: '10%' },
          { field: 'result', label: 'user-command-history.label-result', width: '10%' },
        ],
        rows:       [],
        pagination: {
          total_items: 0,
