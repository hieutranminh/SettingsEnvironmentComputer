    ...
    <div class="table-box mb5">
      ...
      >
        <template
          ...
          slot-scope="{ row }"
        >
          {{ formatDateCol(row.registration_date) }}xx
        </template>
        <template
          slot="function_type"
          slot-scope="{ row }"
...
export default {
  ...
  data() {
    return {
      ...
      table_data: {
        fields: [
          { field: 'registration_date', label: 'user-command-history.label-date', width: '10%', expand: true },
          { field: 'subscriber_number', label: 'user-command-history.label-subscriber-number', width: '10%', expand: true },
          { field: 'subscriber_name', label: 'user-command-history.label-subscriber-name', width: '10%', expand: true },
          { field: 'business_type_code', label: 'user-command-history.label-business-type', width: '10%', expand: true },
          { field: 'function_type', label: 'user-command-history.label-function', width: '10%', expand: true },
          { field: 'command', label: 'user-command-history.label-command', width: '30%', expand: true },
          { field: 'failure_code', label: 'user-command-history.label-failure-code', width: '10%', expand: true },
          { field: 'result', label: 'user-command-history.label-result', width: '10%', expand: true },
        ],
        rows:       [],
        pagination: {
          total_items: 0,
