...
export const gotoLoginPageWhenPossible = (countryCode: string): boolean => {
  ...
  // const handleRouterNavigation = async (): Promise<void> => {
  //   try {
  //     const routerModule = await import('@/router')
  //     await routerModule.default.push({ path: loginPage })
  //   } catch {
  //     // Fallback: try window.location if router import or push fails
