...
// export const changePrimaryColor = (colorName: keyof typeof colorPalettes) => {
//   updatePrimaryPalette(colorPalettes[colorName])
// }

// // Change surface colors
// export const changeSurfaceTheme = (lightSurface: string, darkSurface: string) => {
...
// export const applyThemeVariation = (variation: 'default' | 'compact' | 'material') => {
//   switch (variation) {
//     case 'compact':
//       updatePreset({
//         semantic: {
...
// export const getDesignToken = (tokenPath: string) => {
//   return $dt(tokenPath)
// }
