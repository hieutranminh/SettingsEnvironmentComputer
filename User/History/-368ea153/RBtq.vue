  ...
  data() {
    return {
      prepaidCardFields: [
        ...
        {field: 'prepaid_card_name', label: 'sales-prepaid-card-tab.card-name', width: '30%', sortable: false, expand: true },
  ...
  computed: {
    ...
    tableData() {
      const rows = this.clientPrepaidCard?.items.map(prepaidCard => {
        ...
        console.log('expiry_date_ts:', prepaidCard.expiry_date_ts)
        console.log('prepaid_card_type:', prepaidCard.prepaid_card_type)
        console.log('balance:', prepaidCard.balance)
        ...
        console.log('isCardEmptyBalance:', isCardEmptyBalance)
        console.log('isCardExpired:', isCardExpired)
