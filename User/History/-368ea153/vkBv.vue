...
export default {
  ...
  async created(){
    ...
    this.prepaidCardFilter.shop_id = this.shop_data.shop_id
    this.prepaidCardFilter.include_expired_card = this.getShowExpiredFromLocalStorage('prepaid_cards_show_expired')
  ...
  methods: {
    ...
    onChangeShowExpiredAsync(includeExpiredCard){
      ...
      this.saveShowExpiredToLocalStorage('prepaid_cards_show_expired', includeExpiredCard)
      this.loadDataTableAsync(PAGE_NUMBER_DEFAULT)
    },

    getShowExpiredFromLocalStorage(storageKey) {
    ...
    saveShowExpiredToLocalStorage(storageKey, value) {
