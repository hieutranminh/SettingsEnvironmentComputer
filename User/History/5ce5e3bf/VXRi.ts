...
export type ServiceCategoryResponse = ListResponse<ServiceCategoryItem>
...
export const servicesReadService = {
  ...
  getServiceCategory: async (params: ServiceCategoryRequest): Promise<ApiResponse<ServiceCategory>> => {
    return await goodsReadService.get<ServiceCategory>(`ServiceCategory/${id}`)
  },
}
