...
import { SPACING, PDF_TABLE_STYLES, TABLE_CONFIG, PDF_FONT_SIZES } from '../constants'
...
export const usePdfTable = (): UsePdfTableReturn => {
   ...
   */
  const createPageDrawHandler = (config: Required<PdfConfig>, context: PdfProcessingContext) =>
    ({ doc }: { doc: jsPDF }) => {
  ...
  const createTableConfig = (
    ...
    const baseConfig = createTableBaseConfig(section, tableElement, currentY)
