...
export const usePdfTable = (): IUsePdfTableReturn => {
   ...
   */
  const createTableStyles = (section: PrintSection): Record<string, unknown> => ({
    headStyles: {
   ...
   */
  const createTableMargins = (context: PdfProcessingContext): Record<string, unknown> => ({
    margin: {
   ...
   */
  const createOptionalTableConfig = (section: PrintSection): Record<string, unknown> => ({
