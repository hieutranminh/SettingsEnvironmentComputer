  ...
  methods: {
    ...
    onClickSalesItemTab(value) {
      if (this.table_filter.sales_item_type !== value) {
        ...
        // Set default display_by_type based on selected tab
        if (value === sales_options.sales_goods_type.prepaid_service) {
          this.table_filter.display_by_type = DISPLAY_TYPE.SERVICE
        } else if (value === sales_options.sales_goods_type.service) {
