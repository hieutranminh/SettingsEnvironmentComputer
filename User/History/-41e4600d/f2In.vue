...
export default {
  ...
  methods: {
    ...
    setDefaultDisplayByType() {
      if (this.table_filter.sales_item_type === sales_options.sales_goods_type.prepaid_service) {
        this.table_filter.display_by_type = DISPLAY_TYPE.SERVICE
      } else if (this.table_filter.sales_item_type === sales_options.sales_goods_type.service) {
        this.table_filter.display_by_type = DISPLAY_TYPE.CATEGORY
      }
    },
