...
### Phase 2: Core Logic
- [ ] Create Pinia setup store
- [ ] Implement main composable (`usePrintPreview`)
- [ ] Create PDF and Excel generator composables
- [ ] Build base worker handler

### Phase 3: Worker System
- [ ] Implement main worker file
- [ ] Create modular worker handlers
- [ ] Migrate existing report types to handlers
- [ ] Add error handling and progress tracking

### Phase 4: Components
- [ ] Create PrintPreview component
- [ ] Implement PrintPreviewModal
- [ ] Build PrintPreviewButton
