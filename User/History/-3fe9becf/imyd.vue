...
export default {
  ...
  computed: {
    ...
    aiSummaryOverallRevenue() {
      return this.getAiSummaryWithFallback(
        this.parsedAiOutputSales,
        'overall_revenue',
        this.overallRevenueData,
        this.reportDataSales?.isFailedGenerate,
        this.reportDataSales?.aiOutput,
      )
    },
    ...
    aiSummaryBooking() {
      return this.getAiSummaryWithFallback(
        this.parsedAiOutputBooking,
        'booking_efficiency',
        this.bookingData,
        this.reportDataBooking?.isFailedGenerate,
        this.reportDataBooking?.aiOutput,
      )
    },
  ...
  methods: {
    ...
    getAiSummaryWithFallback({ parsedOutput, sectionKey, sectionData, isFailedGenerate, rawAiOutput }) {
      ...
      // If section data exists but no AI section found in output, show failed message
