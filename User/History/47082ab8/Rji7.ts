...
import type { BranchSalesTotalFilterRequest, BranchSalesTotalFilterResponse } from '@/types/admins/BranchSalesTotalFilter'
 ...
 */
export const fetchBranchSalesTotalFilter = async (
  request: BranchSalesTotalFilterRequest,
): Promise<ApiResponse<BranchSalesTotalFilterResponse>> => {
  return apiRead.post<BranchSalesTotalFilterResponse>(API_ENDPOINTS.ADMINS.BRANCH_SALES_TOTAL_FILTER, request)
}
