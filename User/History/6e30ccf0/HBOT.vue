...
// Utils
import { formatDate, fromUnixTimestamp, validateNotExceedOneMonthRange } from '@/utils/dateUtils'
...
const handleSearchClick = (): void => {
  if (localFilters.dateType === DATE_TYPE.RANGE) {
    const fromDate = formatDate(fromUnixTimestamp(localFilters.fromDateTs))
    const toDate = formatDate(fromUnixTimestamp(localFilters.toDateTs))

    console.log('fromDate', fromDate)
    console.log('toDate', toDate)
    console.log('validateNotExceedOneMonthRange', validateNotExceedOneMonthRange(fromDate, toDate))
  }
