<template>
  ...
  <!-- Filter -->
  <ServiceSalesFilter v-model="filters" @chartTypeChanged="handleChartTypeChanged" />
...
// Constants
import { TIMEZONE_TYPE, DATE_TYPE, FILTER_VALUES, REPORT_BY_TYPE, CHART_TYPE } from '@/constants'
// Stores
...
// State
const chartType = ref(CHART_TYPE.BAR)
...
const handleChartTypeChanged = (value: number): void => {
  console.log('chartTypeChanged', value)
}
