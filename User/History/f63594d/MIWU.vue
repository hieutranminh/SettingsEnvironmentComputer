  ...
  <div class="ai-message-result-list">
    ...
    >
      ...
      <div class="ai-message-result-list__actions">
        <!-- Delete Button -->
        <a
          :id="`ai-message-result-list__delete-button-${index}`"
        ...
        <aha-tooltip
          :target="`ai-message-result-list__delete-button-${index}`"
          placement="bottom"
        >
        ...
        <!-- Save Button -->
        <a
          :id="`ai-message-result-list__save-button-${index}`"
        ...
        <aha-tooltip
          :target="`ai-message-result-list__save-button-${index}`"
          placement="bottom"
        >
