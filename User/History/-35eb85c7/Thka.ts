...
import { EXCEL_IMAGE } from '../constants/excel/index'
 ...
 */
export const getMaxTableColumns = (sections: PrintSection[]): number => {
  let maxColumns = 1
 ...
 * @param maxColumns - Maximum columns in worksheet
 * @param columnWidth - Default column width
 * @param maxHeight - Maximum allowed height
 * @returns Calculated dimensions
 *
 * Example:
 *   const dims = calculateImageDimensions(1200, 800, 6, 25, 400)
...
export const calculateImageDimensions = (
  ...
  const canvasWidthBound = maxColumns * columnWidth * EXCEL_IMAGE.COLUMN_TO_PIXEL_FACTOR
 ...
 */
export const hasTableData = (section: PrintSection): boolean => {
 ...
 */
export const hasTextData = (section: PrintSection): boolean => {
 ...
 */
export const hasCanvasData = (section: PrintSection): boolean => {
