...
// Constants
import { DOWNLOAD_TYPE, FILE_NAME_FORMATS } from '@/constants'
// Stores
...
const reportDownloadFileName = computed(() => {
  return `${config.value?.title} (${formatDate(new Date(), { format: FILE_NAME_FORMATS.PRINT_PREVIEW })})`
})
...
const handleOnLoaded = (doc: PDFDocumentProxy): void => {
