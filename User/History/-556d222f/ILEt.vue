...
// Stores
// Types
import type { ProductSalesByItemFilterInterface } from '@/types/sales-report/ProductSalesByItem'
// Utils
import { fromUnixTimestamp, validateExceedOneMonthRange, validateToDateNotBeforeFromDate } from '@/utils/dateUtils'

const props = defineProps<{
  modelValue: ProductSalesByItemFilterInterface
  chartDisplayType: string
  chartDisplayValue: number
}>()

const emit = defineEmits<{
  (e: 'update:modelValue', value: ProductSalesByItemFilterInterface): void
...
const reportByTypeOptions = computed(() => [
  ...
  { id: REPORT_BY_TYPE_PRODUCT.PRODUCT_CATEGORY, name: t('product-sales-by-item.label-product-category') },
...
const emitUpdateModelValue = (value: Partial<ProductSalesByItemFilterInterface>): void => {
