<template>
  <div class="date-picker-group">
    ...
    <div class="date-picker-group-type">
      ...
      <div v-if="!hiddenDate" class="date-picker-group-item">
        <RadioButton
...
import type { DateType, DateValue } from '@/types/Common'
...
const handlePreviousDate = (): void => {
  ...
  emitDateChange(createDateRangeTs(startOfDay, endOfDay), props.fetchOnNavigate)
}
...
const handlePreviousMonth = (): void => {
  ...
  emitDateChange(createDateRangeTs(startOfMonth, endOfMonth), props.fetchOnNavigate)
}
...
const emitDateChange = (
  dateRange: { fromDateTs: number; toDateTs: number },
  fetchOnNavigate: boolean = false,
): void => {
  emits('dateChange', dateRange, fetchOnNavigate)
}
</script>
