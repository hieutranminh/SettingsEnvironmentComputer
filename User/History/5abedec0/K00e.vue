...
const props = defineProps<{
  modelValue: IServiceSalesBySalesTypeFilterInterface
}>()

const emit = defineEmits<{
  (e: 'update:modelValue', value: IServiceSalesBySalesTypeFilterInterface): void
...
const emitUpdateModelValue = (value: Partial<IServiceSalesBySalesTypeFilterInterface>): void => {
