        ...
        <div class="filter-form">
          ...
          <div class="filter-form-counting">
            <label for="prepaid-sales-counting" class="prepaid-sales-counting-label">
              ...
              <TooltipWithIconQuestion :tooltip="$t('service-sales-by-sales-type.tooltip-prepaid-sales-counting')" />
            </label>
            ...
            <div class="filter-form-radio">
              <div class="filter-form-radio-item">
                ...
                />
                <label for="when-sold">{{ $t('service-sales-by-sales-type.label-when-sold') }}</label>
              </div>
              <div class="filter-form-radio-item">
                <RadioButton
                  v-model="prepaidSalesCountingModel"
                ...
                />
                <label for="when-used">{{ $t('service-sales-by-sales-type.label-when-used') }}</label>
              </div>
            </div>

            <div class="filter-form-checkbox">
              <Checkbox v-model="isPointDeductionIncludedModel" />
