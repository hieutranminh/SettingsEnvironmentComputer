...
export default {
  ...
  props: {
    ...
    defaultDisplayItem: {
      type:    String,
      default: DISPLAY_ITEM_TYPES.REVENUE_TOTAL,
    },
  },
  ...
  computed: {
    // Map display item value to i18n key - không phụ thuộc disabledDisplayItem
    displayItemLabelMap() {
      return {
    ...
    // Lấy label từ map - chỉ phụ thuộc selectedDisplayItem, không phụ thuộc disabledDisplayItem
