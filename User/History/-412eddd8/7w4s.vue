...
const reportTypeLabel = computed(() => {
  switch (props.reportType) {
    case REPORT_TYPE_IN_CLIENTS_BY_TYPE.SEX:
      return t('clients-by-type.label-sex')
    case REPORT_TYPE_IN_CLIENTS_BY_TYPE.CLIENT_RATING:
      return t('clients-by-type.label-client-rating')
    case REPORT_TYPE_IN_CLIENTS_BY_TYPE.CLIENT_GROUP:
      return t('clients-by-type.label-client-group')
    default:
