        ...
        <ColumnGroup v-if="transformedData.length" type="footer">
          <Row>
            ...
            <Column footerClass="bg-gray">
              <template #footer>
                <span class="total-quantity">{{ formatAmount(getColumnTotal('noInput').quantity) }}</span>
                <p class="total-amount">{{ formatAmount(getColumnTotal('noInput').amount) }}</p>
              </template>
            </Column>

            <!-- Dynamic Sales Type Column Footers -->
            <Column v-for="salesType in salesTypeData" :key="`footer-${salesType.id}`" footerClass="bg-gray">
              <template #footer>
                <span class="total-quantity">{{
                  formatAmount(getColumnTotal('salesType', salesType.id).quantity)
                }}</span>
                <p class="total-amount">{{ formatAmount(getColumnTotal('salesType', salesType.id).amount) }}</p>
              </template>
            </Column>
            ...
            <Column footerClass="bg-gray">
              <template #footer>
                <span class="total-quantity">{{ formatAmount(getColumnTotal('total').quantity) }}</span>
