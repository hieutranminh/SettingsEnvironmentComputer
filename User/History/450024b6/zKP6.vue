        ...
        <ColumnGroup v-if="transformedData.length" type="footer">
          <Row>
            ...
            <Column footerClass="bg-gray">
              <template #footer>
                <span class="total-quantity">{{ formatAmount(10) }}</span>
                <p class="total-amount">{{ formatAmount(10) }}</p>
              </template>
            </Column>

            <!-- No Input Column Footer -->
            <Column :footer="getColumnTotal('noInput')" footerClass="bg-gray" />
            ...
            <!-- Total Column Footer -->
            <Column :footer="getColumnTotal('total')" footerClass="bg-gray" />
          </Row>
        </ColumnGroup>
      </DataTable>
    </template>
