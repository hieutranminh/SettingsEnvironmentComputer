...
export const branchRoutes: RouteRecordRaw[] = [
    ...
    children: [
      {
        ...
        component: () => import('@/views/sales-total-by-branch/SalesTotalView.vue'),
        meta: {
          requiresAuth: true,
        },
      },
      {
        ...
        component: () => import('@/views/sales-total-by-branch/SalesByStaffView.vue'),
        meta: {
          requiresAuth: true,
        },
      },
      {
        ...
        component: () => import('@/views/sales-total-by-branch/SalesByItemView.vue'),
        meta: {
          requiresAuth: true,
        },
      },
  ...
  },
  {
    ...
    component: () => import('@/views/branch/branches/BranchesView.vue'),
    meta: {
      requiresAuth: true,
    },
  },
