        ...
        >
          <template #value="slotProps">
            <div v-if="slotProps.value" class="color-option">
              <span class="color-dot" :style="{ backgroundColor: getColorHex(slotProps.value) }" />
              <span>{{ formatColorLabel(slotProps.value) }}</span>
            </div>
          </template>
      ...
      <div class="control-item">
        ...
        <div class="dark-mode-toggle">
          ...
          <span class="dark-mode-label">
            <i :class="preferences.darkMode ? 'pi pi-moon' : 'pi pi-sun'" />
...
// Terminal-like output - use fixed dark colors to work in both light and dark mode
.raw-output {
  background: #1e1e2e;
  border: 1px solid var(--p-surface-300);
  border-radius: 8px;
