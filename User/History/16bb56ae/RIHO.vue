...
const { showError, showInfo, showWarning, showErrorNow } = useMessageDialog()

const testMultipleErrors = () => {
  // 3 lỗi sẽ hiển thị lần lượt
  showErrorNow('Lỗi 1', 'Không thể kết nối database', () => {
    console.log('Lỗi 1 đã đóng')
  })
  showErrorNow('Lỗi 2', 'Session hết hạn', () => {
    console.log('Lỗi 2 đã đóng')
  })
  showErrorNow('Lỗi 3', 'Không có quyền truy cập', () => {
    console.log('Lỗi 3 đã đóng')
  })
}
