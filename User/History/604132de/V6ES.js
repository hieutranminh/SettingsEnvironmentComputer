...
export const TOOLTIP_TEXT_MAX_LENGTH_TO_SHOW_IN_TOOLTIP = 500
export const INFORMATION_TYPE_COMMA_REPLACE_SPACE = 4 // ADDITIONAL_INFORMATION

export const MONTHOFYEAR = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec']
export const MONTHOFYEARFULLNAME = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December']
...
export const DEFAULT_INPUT_MODE = {
  TEXT:  0,
  VOICE: 1,
}

export const IS_OPTIMAL_BOOKING_TIME_RECOMMENDATION = {
  ON:  true,
  OFF: false,
}

export const STORAGE_AHA_AI_DEFAULT_INPUT_MODE = 'aha-ai-default-input-mode'

export const AHA_AI_INTENT_TYPE = {
  SEARCH_CLIENT:          'SearchClient',
  SEARCH_BOOKING:         'SearchBooking',
  SEARCH_AVAILABLE_TIMES: 'SearchAvailableTimes',
  ADD_BOOKING:            'AddBooking',
}
...
export const BOOKING_SEARCH_TYPE = {
  SEARCH_ALL:                              0,
  SEARCH_AVAILABLE_TIMES_AND_ADD_BOOKINGS: 1,
  SEARCH_AVAILABLE_TIMES_ONLY:             2,
}

export const CLIENT_TARGET_TYPE = {
  ALL_CLIENT:                         'allClients',
  BIRTHDAY_CLIENTS:                   'birthdayClients',
  CLIENTS_BY_PREPAID_CARDS:           'clientsByPrepaidCards',
  CLIENT_BY_PREPAID_SERVICE:          'clientsByPrepaidService',
  CLIENT_BY_SALES_PRODUCT:            'clientsBySalesProduct',
  CLIENT_BY_SALES_SERVICE:            'clientsBySalesService',
  CLIENT_WITH_NO_VALID_PREPAID_GOODS: 'clientsWithNoValidPrepaidGoods',
  CLIENT_WITH_VALID_PREPAID_GOODS:    'clientsWithValidPrepaidGoods',
  DORMANT_CLIENTS:                    'dormantClients',
  RECOMMENDED_CLIENTS:                'recommendedClients',
  CLIENTS_BY_SALES_AMOUNT:            'clientsBySalesAmount',
  CLIENTS_BY_SALES_PRODUCT:           'clientsBySalesProduct',
  CLIENTS_BY_PREPAID_SERVICES:        'clientsByPrepaidServices',
}

export const CLIENT_TARGET_ENUM = {
  ALL_CLIENT:                         1,
  DORMANT_CLIENTS:                    2,
  CLIENT_BY_SALES_SERVICE:            3,
  CLIENTS_BY_SALES_PRODUCT:           4,
  CLIENTS_BY_SALES_AMOUNT:            5,
  CLIENTS_BY_PREPAID_CARDS:           6,
  CLIENT_BY_PREPAID_SERVICE:          7,
  CLIENT_BIRTHDAY:                    8,
  RECOMMENDED_CLIENTS:                9,
  CLIENT_WITH_VALID_PREPAID_GOODS:    10,
  CLIENT_WITH_NO_VALID_PREPAID_GOODS: 11,
}

export const CLIENT_MANAGEMENT_TARGET_TYPE = {
  'allClients':                     CLIENT_TARGET_ENUM.ALL_CLIENT,
  'dormantClients':                 CLIENT_TARGET_ENUM.DORMANT_CLIENTS,
  'clientsBySalesService':          CLIENT_TARGET_ENUM.CLIENT_BY_SALES_SERVICE,
  'clientsBySalesProduct':          CLIENT_TARGET_ENUM.CLIENTS_BY_SALES_PRODUCT,
  'clientsBySalesAmount':           CLIENT_TARGET_ENUM.CLIENTS_BY_SALES_AMOUNT,
  'clientsByPrepaidCards':          CLIENT_TARGET_ENUM.CLIENTS_BY_PREPAID_CARDS,
  'clientsByPrepaidService':        CLIENT_TARGET_ENUM.CLIENT_BY_PREPAID_SERVICE,
  'clientsByBirthday':              CLIENT_TARGET_ENUM.CLIENT_BIRTHDAY,
  'recommendedClients':             CLIENT_TARGET_ENUM.RECOMMENDED_CLIENTS,
  'clientsWithValidPrepaidGoods':   CLIENT_TARGET_ENUM.CLIENT_WITH_VALID_PREPAID_GOODS,
  'clientsWithNoValidPrepaidGoods': CLIENT_TARGET_ENUM.CLIENT_WITH_NO_VALID_PREPAID_GOODS,
}
...
export const AHA_AI_TONE_STYLE = {
  FORMAL_NOTIFICATION:      0,
  FRIENDLY_CONVERSATIONAL:  1,
  EMOTIONAL_EMPATHY:        2,
  HUMOROUS_CASUAL:          3,
  PROFESSIONAL_INFORMATIVE: 4,
}

export const AHA_AI_LANGUAGE = {
  ENGLISH: 0,
  KOREAN:  1,
}
