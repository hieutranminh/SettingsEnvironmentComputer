  ...
  >
    ...
    <ColumnGroup type="header">
      <Row>
        ...
        <Column :colspan="4" :header="$t('branch-sales.label-service')" :headerClass="TABLE_CONSTANTS.CLASSES.YELLOW" + "border-bottom-0" />
        <Column :colspan="3" :header="$t('branch-sales.label-product')" :headerClass="TABLE_CONSTANTS.CLASSES.YELLOW" + "border-bottom-0" />
