    ...
    <ColumnGroup type="header">
      ...
      <Row>
        <Column field="serviceSales" headerClass="bg-green">
          <template #header>
            <p class="text-no-wrap">
              {{ $t('branch-sales.label-sales') }} (<span class="text-blue">S1</span>)
            </p>
          </template>
        </Column>
        <Column
        ...
        <Column field="productSales" headerClass="bg-green">
          <template #header>
            <p class="text-no-wrap">
              {{ $t('branch-sales.label-sales') }} (<span class="text-blue">S2</span>)
            </p>
          </template>
        </Column>
        <Column
        ...
        <Column field="prepaidTotal" headerClass="bg-green">
          <template #header>
            <p class="text-no-wrap">
              {{ $t('branch-sales.label-total') }} (<span class="text-blue">S3</span>)
            </p>
          </template>
        </Column>
      </Row>
...
import type { BranchSalesReportData } from '@/types/sales-report/BranchSales'
