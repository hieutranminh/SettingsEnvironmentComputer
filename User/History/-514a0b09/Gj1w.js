...
/**
 * Format yearMonth string from YYYYMM to MMM-YY (label format for charts)
 * @param {string} yearMonth - String in format YYYYMM (e.g., "202411")
 * @returns {string} Formatted string MMM-YY (e.g., "Nov-24") with i18n support
 */
export function formatYearMonthLabel(yearMonth) {
  ...
  return date.locale(i18n.locale).format('MMM-YY')
}
