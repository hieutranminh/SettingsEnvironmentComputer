...
export default defineConfig({
  plugins: [
    ...
    //     tsconfigPath: './tsconfig.json', // Use app tsconfig for src files
    ...
    //   eslint: {
    //     lintCommand:
    //       'eslint "./src/**/*.{vue,js,ts,jsx,tsx}" --config eslint.config.ts',
    //     dev: {
    ...
    //   stylelint: {
    //     lintCommand:
    //       'stylelint "src/**/*.{css,scss,vue}" --custom-syntax postcss-html',
    //   },
    //   overlay: {
