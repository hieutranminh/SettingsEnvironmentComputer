...
export default defineConfig({
  plugins: [
    ...
    checker({
      ...
      eslint: {
        lintCommand:
          'eslint "./src/**/*.{vue,js,ts,jsx,tsx}" --config eslint.config.ts --cache --cache-location node_modules/.cache/eslint/',
        dev: {
      ...
      stylelint: {
        lintCommand:
          'stylelint "src/**/*.{css,scss,vue}" --custom-syntax postcss-html --cache --cache-location node_modules/.cache/stylelint/',
      },
