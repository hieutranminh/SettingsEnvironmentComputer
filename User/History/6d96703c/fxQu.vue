...
export default {
  ...
  methods: {
    ...
    async callGetAvailableTimesAndOpenResult(resultData) {
      try {
        ...
        const calculatedEstimatedTime = this.calculateEstimatedTimeFromItems(
          ...
          selectedServiceItems,
          selectedBookingItems,
          resultData.queryParameters.estimatedTime,
        )
        const payload = {
    ...
    calculateEstimatedTimeFromItems(servicesAndBookingItems, selectedServiceItems, selectedBookingItems, promptEstimatedTime) {
      if (!servicesAndBookingItems) {
        return null
      }
      ...
      if (totalEstimatedTime === 0) {
        return promptEstimatedTime > 0 ? promptEstimatedTime : DEFAULT_ESTIMATED_TIME_FALLBACK
      }
