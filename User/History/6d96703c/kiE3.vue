...
export default {
  ...
  methods: {
    ...
    validateServicesAndBookingItems(servicesAndBookingItems, estimatedTime) {
      ...
      if (estimatedTime === 0) {
        // Check if no matched items at all
        ...
        // Check if matched items exist but all have 0 estimated time
        const calculatedEstimatedTime = this.calculateEstimatedTimeFromItems(servicesAndBookingItems, {}, {})
