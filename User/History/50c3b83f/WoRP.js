...
const INITIAL_SILENCE_TIMEOUT_MS = 6000 // Timeout when user hasn't spoken anything yet
const AFTER_SPEECH_SILENCE_TIMEOUT_MS = 3000 // Timeout after user has spoken and paused
