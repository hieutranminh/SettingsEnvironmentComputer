...
export default {
  ...
  methods: {
    ...
    _handleOnResult(recognition, result) {
      ...
      // Android/Samsung fix: Use fullFinalTranscript which is rebuilt from ALL results
      // This completely avoids duplicate issues since we're not accumulating incrementally
      if (result.fullFinalTranscript !== undefined) {
