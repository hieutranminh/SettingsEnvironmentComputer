...
<template>
  <div class="dialog-content">
    ...
    <div v-if="isStructuredError" >
      <Button @click="handleToggleErrorDetails" size="small" :label="showErrorDetails ? 'Hide Error Details' : 'Show Error Details'" severity="contrast" variant="text" />
      <a href="#">{{ showErrorDetails ? 'Hide Error Details' : 'Show Error Details' }}</a>
