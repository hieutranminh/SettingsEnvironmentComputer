...
<template>
  ...
  >
    ...
    >
      <calendar-slot-menu
        ref="slotMenu"
        :time-text="textTimeMobile"
        :is-touch-device="isTouchDevice()"
        @add-booking="handleSlotClick"
        @block-booking="handleAddBlockedTimeClick"
      />
    </div>
...
export default {
  components: {
    ...
    CalendarSlotMenu:     () => import('./components/calendar-slot-menu/calendar-slot-menu.vue'),
  },
  ...
  computed: {
    ...
    calendarSlotClass() {
      return ['calendar-slot', {
        ...
        'calendar-slot--hovered':  this.isHovered,
  ...
  methods: {
    ...
    handleContextMenuHide() {
      const slotMenu = this.$refs.slotMenu
      if (slotMenu) {
        slotMenu.hide()
      }
    },
    ...
    handleDocumentMouseMove(event) {
      ...
      const el = this.$refs.slot || this.$el
