...
export default {
  ...
  computed: {
    ...
    calendarSlotClass() {
      return ['calendar-slot', {
        ...
        'calendar-slot--hovered':  this.isHovered && !this.disabled,
  ...
  mounted() {
    ...
    this.$root.$on('bv::dropdown::hide', this.handleDropdownHide)
  ...
  beforeDestroy() {
    ...
    this.$root.$off('bv::dropdown::hide', this.handleDropdownHide)
  },
