<template>
  <main class="app-content">
    <section class="content report-comprehensive-analysis-page">
      ...
      >
        <template #default="scope">
          ...
          <div class="filter-wrapper">
            <report-comprehensive-analysis-filter
              @search="onSearch"
            />
          </div>
...
import ReportComprehensiveAnalysisFilter from './partials/report-comprehensive-analysis-filter.vue'
...
export default {
  components: {
    ...
    ReportInsights,
    ReportComprehensiveAnalysisFilter,
  },
  ...
  computed: {
    reportName() {
      return this.$t('report.comprehensive-analysis')
    },
...
<style lang="scss">
@import './report-comprehensive-analysis.scss';
</style>
