...
function onSearchChange(value: string | null): void {
  emit('update:search', value)
}

function onReleaseNumberChange(value: number | null): void {
  emit('update:releaseNumber', value)
}

function onRegionChange(value: unknown): void {
...
function getStatusSeverityByValue(value: unknown): StatusSeverity | undefined {
