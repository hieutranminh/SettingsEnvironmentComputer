...
export const clientReportReadService = {
   ...
   */
  getNewClientsRepeatReport: (request: NewClientsRepeatReportRequest): Promise<NewClientsRepeatReportResponse> => {
    return apiRead.post<NewClientsRepeatReportResult>('sales/ClientReport/GetNewClientRepeatReport', request)
  },
}
