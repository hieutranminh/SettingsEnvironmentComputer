...
export interface PdfProcessingContext {
  currentY: number
...
export interface ExcelCellTracker {
...
export interface ExcelProcessingContext {
  worksheet: ExcelJS.Worksheet
  cellTracker: ExcelCellTracker
  columnAlignments?: { [columnIndex: number]: 'left' | 'center' | 'right' }
}

export interface ExcelTextFormatState {
  isBold: boolean
  isItalic: boolean
}
