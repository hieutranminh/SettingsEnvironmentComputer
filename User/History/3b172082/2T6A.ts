...
export const setLocalStorageItem = (key: string, value: unknown): void => {
  try {
    ...
    throw new Error(`Failed to set localStorage item '${key}': ${error instanceof Error ? error.message : 'Unknown error'}`)
  }
}
...
export const getLocalStorageItem = <T>(key: string): T | null => {
  try {
    ...
    throw new Error(`Failed to get localStorage item '${key}': ${error instanceof Error ? error.message : 'Unknown error'}`)
  }
}
...
export const removeLocalStorageItem = (key: string): void => {
  try {
    ...
    throw new Error(`Failed to remove localStorage item '${key}': ${error instanceof Error ? error.message : 'Unknown error'}`)
  }
}
...
export const setSessionStorageItem = (key: string, value: unknown): void => {
  try {
    ...
    throw new Error(`Failed to set sessionStorage item '${key}': ${error instanceof Error ? error.message : 'Unknown error'}`)
  }
}
...
export const getSessionStorageItem = <T>(key: string): T | null => {
  try {
    ...
    throw new Error(`Failed to get sessionStorage item '${key}': ${error instanceof Error ? error.message : 'Unknown error'}`)
  }
}
...
export const removeSessionStorageItem = (key: string): void => {
  try {
    ...
    throw new Error(`Failed to remove sessionStorage item '${key}': ${error instanceof Error ? error.message : 'Unknown error'}`)
  }
}
...
export const clearSessionStorage = (): void => {
  try {
    ...
    throw new Error(`Failed to clear sessionStorage: ${error instanceof Error ? error.message : 'Unknown error'}`)
  }
}
 ...
 */
export const setCookie = (key: string, value: unknown, options?: Cookies.CookieAttributes): void => {
  try {
    const serializedValue = JSON.stringify(value)
    Cookies.set(key, serializedValue, options)
  } catch (error) {
    throw new Error(`Failed to set cookie '${key}': ${error instanceof Error ? error.message : 'Unknown error'}`)
  }
}
...
export const getCookie = <T>(key: string): T | null => {
  try {
    ...
    throw new Error(`Failed to get cookie '${key}': ${error instanceof Error ? error.message : 'Unknown error'}`)
  }
}
...
export const removeCookie = (key: string, options?: Cookies.CookieAttributes): void => {
  try {
    ...
    throw new Error(`Failed to remove cookie '${key}': ${error instanceof Error ? error.message : 'Unknown error'}`)
  }
}
