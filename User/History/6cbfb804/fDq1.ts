...
/**
 * Generic constraint for model value objects
 * Ensures type safety without using 'any'
 * Uses object constraint to work with any object type
 */
type ModelValueConstraint = object
 ...
 */
export const useModelBinding = <T extends ModelValueConstraint>(
  props: { modelValue: T },
 ...
 */
export const useStringModelBinding = <T extends ModelValueConstraint>(
  props: { modelValue: T },
  emit: (event: 'update:modelValue', value: T) => void,
  key: keyof T,
  additionalUpdates: Partial<T> = {},
 ...
 */
export const useNumberModelBinding = <T extends ModelValueConstraint>(
  props: { modelValue: T },
  emit: (event: 'update:modelValue', value: T) => void,
  key: keyof T,
  additionalUpdates: Partial<T> = {},
 ...
 */
export const useBooleanModelBinding = <T extends ModelValueConstraint>(
  props: { modelValue: T },
  emit: (event: 'update:modelValue', value: T) => void,
  key: keyof T,
  additionalUpdates: Partial<T> = {},
