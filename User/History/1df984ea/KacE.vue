        ...
        <div class="filter-form">
          ...
          <div class="filter-form-group">
            <div class="filter-form-item">
              <label for="chart">{{ $t('bookings-by-time.label-chart') }}</label>
              <Select
...
import type { IBookingsByTimeFilter } from '@/types/bookings-report/BookingsByTime'
import { useDateRange } from '@/composables/useDateRange'
import { useMessageDialog } from '@/composables/useMessageDialog'
const props = defineProps<{
  modelValue: IBookingsByTimeFilter
  chartDisplayType: ChartDisplayType
}>()
const emit = defineEmits<{
  (e: 'update:modelValue', value: IBookingsByTimeFilter): void
...
const emitUpdateModelValue = (value: Partial<IBookingsByTimeFilter>): void => {
