...
import type { NotificationOptions, NotificationType, NotificationAction } from '@/types/Notification'
...
export const useNotification = () => {
  ...
  const showNotification = (options: NotificationOptions, type: NotificationType) => {
    ...
    dialog.open('NotificationDialog', {
      props: {
        ...
        resizable: normalizedOptions.resizable,
        style: {
