...
const handleDateChange = (value: DateValue): void => {
  const a = convertTimezone(value).format('YYYY-MM-DD HH:mm:ss')
  const b = convertTimezone(value, 'Asia/Seoul').format('YYYY-MM-DD HH:mm:ss')
  console.log('a', a.toDate())
  console.log('b', b.toDate())
