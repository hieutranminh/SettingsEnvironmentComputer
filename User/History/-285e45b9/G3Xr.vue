<template>
  <div class="time-picker">
    ...
    <div class="time-picker-input">
      <!-- Single Date Picker -->
      <div v-if="filterData.dateType === DATE_TYPE.DATE" class="date-picker">
        <DatePicker
          showIcon
          iconDisplay="input"
      ...
      <!-- Month Picker -->
      <div v-if="filterData.dateType === DATE_TYPE.MONTH" class="month-select">
        <DatePicker
          showIcon
          iconDisplay="input"
          view="month"
      ...
      <!-- Date Range Picker -->
      <div v-if="filterData.dateType === DATE_TYPE.RANGE" class="date-range">
        <DatePicker
          id="date-range-from"
          showIcon
          iconDisplay="input"
...
const minDateRange = computed((): Date => {
  return props.initialFromDateTs ? fromUnixTimestamp(props.initialFromDateTs).toDate() : getCurrentDate().toDate()
})

const maxDateRange = computed((): Date => {
  return props.initialToDateTs
    ? fromUnixTimestamp(props.initialToDateTs).subtract(1, 'day').toDate()
