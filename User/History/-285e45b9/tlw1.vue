...
const handleDateChange = (value: DateValue): void => {
  ...
  console.log('a:', a.format('ddd MMM DD YYYY HH:mm:ss [GMT]Z (z)'))
  console.log('b:', b.format('ddd MMM DD YYYY HH:mm:ss [GMT]Z (z)'))
  console.log('Timestamp A:', a.valueOf())
  console.log('Timestamp B:', b.valueOf())
