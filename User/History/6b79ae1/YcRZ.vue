    ...
    <div class="example-section">
      ...
      <div class="button-grid">
        ...
        <Button
          ...
          severity="warn"
          @click="handleMixedErrorTypesClick"
          class="example-button"
        />
      </div>
    </div>
...
const handleMixedErrorTypesClick = (): void => {
  showWarning(
    'Mixed Error Types',
    [
      ...
      {
        errorCode: 'MIX001',
        errorMessage: 'This is a structured error message',
        errorValues: ['value1', 'value2']
      },
      'Another regular string message'
    ]
  )
}
</script>
