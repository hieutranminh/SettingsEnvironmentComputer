  ...
  showInfo(
    ...
    'This dialog demonstrates custom action buttons and callbacks.',
    {
      onClose: () => {
        ...
        showSuccess('Action Completed', 'Custom action was executed successfully!')
      }
    }
  )
}
...
const handleResizableClick = (): void => {
  showSecondary(
    'Resizable Dialog',
    'This dialog can be resized. Try dragging the corners or edges!',
    {
      resizable: true,
      style: {
        width: '450px',
