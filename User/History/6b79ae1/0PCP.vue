<template>
  <div class="dialog-example">
    ...
    <div class="example-section">
      ...
      <div class="button-grid">
        <Button
          label="Info without Title"
          severity="info"
          @click="handleInfoWithoutTitleClick"
          class="example-button"
        />
        <Button
          label="Success without Title"
          severity="success"
          @click="handleSuccessWithoutTitleClick"
          class="example-button"
        />
        <Button
          label="Error without Title"
          severity="danger"
          @click="handleErrorWithoutTitleClick"
          class="example-button"
        />
      </div>
...
// New flexible feature handlers
const handleInfoWithoutTitleClick = (): void => {
  showInfo('This is an info message without a custom title. It will default to "Alert".')
}

const handleSuccessWithoutTitleClick = (): void => {
  showSuccess('Operation completed successfully!')
}

const handleErrorWithoutTitleClick = (): void => {
  showError('Something went wrong with the operation.')
}
</script>
