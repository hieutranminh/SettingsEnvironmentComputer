    ...
    <div class="system-question-container">
      <div class="system-question-panel">
              ...
              <div class="detail-section">
                ...
                <div class="detail-row">
                  ...
                  <div class="detail-value">
                    <InputText v-model="boardActionData.title" class="form-input" />
                  </div>
                </div>
                ...
                <div class="detail-row">
                  ...
                  <template
                    ...
                    "
                  >
                    <div v-if="!isMobile" class="detail-label master-only-label">
                    ...
                    <div class="detail-value">
                      <div class="checkbox-wrapper">
                        ...
                        />
                        <span class="checkbox-text">{{ $t('boards.master-only') }}</span>
                      </div>
                    </div>
                  </template>
                </div>
                ...
                <div class="content-area">
                  <textarea v-model="boardActionData.contents" class="content-textarea" rows="10" />
                </div>
                ...
                >
                  ...
                  <div class="file-section">
                    ...
                    <div class="file-table">
                      ...
                      >
                        <div
                          v-for="(file, index) in boardActionData.fileAttachments"
                          :key="index"
                          class="file-item"
                        >
                          ...
                          <div class="file-action-col">
                            <button class="delete-file-btn" @click="onRemoveFile(file)">
                    ...
                    <div class="file-upload-section">
                      <div class="file-info">
                        <span class="file-info-text">{{ $t('boards.file-info') }}</span>
                      </div>
        ...
        <div class="panel-actions">
          <Button class="action-btn" severity="primary" @click="onSave">
            {{ $t('general.save') }}
          </Button>
          <Button class="action-btn" severity="info" @click="onCancel">
            {{ $t('general.cancel') }}
          </Button>
        </div>
      </div>
...
import { FORM_ACTION, PAGINATION, SEARCH_BOARD_TYPE, USER_ROLES } from '@/constants'
