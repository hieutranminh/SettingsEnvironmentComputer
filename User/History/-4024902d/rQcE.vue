...
export default {
  ...
  computed: {
    ...
    isDeductPrepaidServicesButtonShown() {
      return (this.isCheckedOutBookingStatus || this.isNoShowBookingStatus) || this.booking.salesId
    },
  ...
  methods: {
    ...
    checkStatusPrepaidService(prepaidService) {
      ...
      const isExpired = salesUtils.isExpiredCard(prepaidService.expiryDateTS)
