      ...
      >
        ...
        >
          <div class="sales-prepaid-services__wrapper--mobile">
            <b-form-checkbox
              ...
              :key="`select-mobile-${row.id}-${haveOnlyOneValidPrepaidServices}`"
        ...
        >
          <b-form-checkbox
            ...
            :key="`select-${row.id}-${haveOnlyOneValidPrepaidServices}`"
            :checked="isRowChecked(row)"
            class="sales-prepaid-services__checkbox"
            @change="onSelectPrepaidServiceRowData(row)"
          />
...
export default {
  ...
  methods: {
    ...
    onSelectPrepaidServiceRowData(prepaidService) {
      // If only one valid service, keep it always selected
