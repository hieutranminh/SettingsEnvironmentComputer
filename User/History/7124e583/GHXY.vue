        ...
        >
          <div class="sales-prepaid-services__wrapper--mobile">
            ...
            <div class="sales-prepaid-services__main-container--mobile">
              ...
              <div class="row">
                <p class="col-6">
                  {{ $t('sales-prepaid-service-tab.expiry-date') }}xxx
                </p>
                <p class="col-6">
                  {{ salesUtils.formatNoLimitDateTs(row.expiry_date_ts) }}yyy
                </p>
              </div>
...
const DEFAULT_PREPAID_SERVICE_FIELDS = [
  ...
  {field: 'prepaid_service_name', label: 'sales-prepaid-service-tab.prepaid-service-name', width: '30%', sortable: false, expand: true},
...
export default {
  ...
  computed: {
    ...
    prepaidServiceFields() {
      ...
      if(this.haveMoreThanOneValidPrepaidServices && this.isDeductPrepaidServicesButtonShown) {
  ...
  watch: {
    clientId(newValue, oldValue){
      if(newValue !== oldValue && !!oldValue) {
        ...
        this.$nextTick(() => {
          this.prepaidServiceFilter.show_expired = false
