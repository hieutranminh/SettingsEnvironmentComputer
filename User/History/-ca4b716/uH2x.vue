...
// Report headers
const reportHeaders = ref<ReportHeader[]>([{ title: 'Báo Cáo Doanh Thu', subtitle: 'Tháng 1/2024' }])
...
const handleComposablePrint = async () => {
  try {
    await startPrintPreview(WORKER_TYPES.SALES_HISTORY, tableHeaders.value, reportHeaders.value, requestPayload.value)
