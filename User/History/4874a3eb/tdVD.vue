...
const DEFAULT_SELECTED_STAFF_COUNT = 2
...
export default {
  ...
  methods: {
    initializeSelectedItems() {
      // Initialize with top N staff selected (based on DEFAULT_SELECTED_STAFF_COUNT)
      this.selectedItems = this.displayItemOptions.slice(0, DEFAULT_SELECTED_STAFF_COUNT)
    },
