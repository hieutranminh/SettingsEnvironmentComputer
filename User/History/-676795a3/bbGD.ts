...
export const BOARD_ROUTES = {
  ...
  BRANCH_BOARD_ACTION: 'branch-board-action',
  ...
  SYSTEM_BOARD_DETAIL: 'system-board-detail',
  SYSTEM_BOARD_ACTION: 'system-board-action',

  // Chain Notice
  CHAIN_NOTICE: 'chain-notice',
  CHAIN_NOTICE_DETAIL: 'chain-notice-detail',
  CHAIN_NOTICE_ACTION: 'chain-notice-action',
} as const
