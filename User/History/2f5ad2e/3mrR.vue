...
import type { IClientsByPeriodFilterInterface } from '@/types/client-report/ClientsByPeriod'

const props = defineProps<{
  modelValue: IClientsByPeriodFilterInterface
}>()

const emit = defineEmits<{
  (e: 'update:modelValue', value: IClientsByPeriodFilterInterface): void
...
const { validateDateRange } = useDateRangeFilter(toRef(props, 'modelValue'))
...
const emitUpdateModelValue = (value: Partial<IClientsByPeriodFilterInterface>): void => {
