 ...
 */
export const extractChartData = <T extends BaseChartDataItem>(data: T[], displayValue: number): number[] => {
 ...
 */
export const formatChartLabel = (value: string, fallbackKey: string, t: (key: string) => string): string => {
