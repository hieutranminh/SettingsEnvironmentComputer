      ...
      <template #content>
        <div class="preferences-view__controls">
          <div class="preferences-view__control">
            <label class="preferences-view__label">{{ $t('preferences.themePreset') }}</label>
            <Select
              v-model="preferences.preset"
              :options="presetOptions"
              option-label="label"
              option-value="value"
              :placeholder="$t('preferences.selectPreset')"
              class="w-full"
          ...
          <div class="preferences-view__control">
            <label class="preferences-view__label">{{ $t('preferences.primaryColor') }}</label>
            <Select
              v-model="preferences.primaryColor"
              :options="colorOptions"
              option-label="label"
              option-value="value"
              :placeholder="$t('preferences.selectColor')"
              class="w-full"
          ...
          <div v-if="preferences.primaryColor === 'custom'" class="preferences-view__control">
            <label class="preferences-view__label">{{ $t('preferences.customColor') }}</label>
          ...
          <div class="preferences-view__control">
            <label class="preferences-view__label">{{ $t('preferences.surfaceColor') }}</label>
            <Select
              v-model="preferences.surfaceColor"
              :options="surfaceOptions"
              option-label="label"
              option-value="value"
              :placeholder="$t('preferences.selectSurface')"
              class="w-full"
              @change="onThemeChange"
            >
              <template #value="slotProps">
          ...
          <div class="preferences-view__control">
            <label class="preferences-view__label">
              {{ $t('preferences.mode') }}
              (
              {{ preferences.darkMode ? $t('preferences.darkMode') : $t('preferences.lightMode') }}
              )
            </label>
