...
const filters = ref<IServiceSalesByMonthFilterInterface>({
...
const handlePrint = async (): Promise<void> => {
  ...
  if (serviceSalesByMonthChartRef.value)
    sections.push(serviceSalesByMonthChartRef.value.getPrintConfiguration())
  if (serviceSalesByMonthTableRef.value)
    sections.push(serviceSalesByMonthTableRef.value.getPrintConfiguration())
