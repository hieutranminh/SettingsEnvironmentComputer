...
// Constants
import { TIMEZONE_TYPE, CHART_DISPLAY_TYPE, CHART_DISPLAY_VALUE, FILTER_VALUES, PREPAID_SALES_COUNTING_TYPE } from '@/constants'
// Stores
...
const dateMappedText = computed(() => {
  ...
  return `${formatDate(fromUnixTimestamp(fromDate), { timezone: TIMEZONE_TYPE.UTC })} - ${formatDate(fromUnixTimestamp(toDate), { timezone: TIMEZONE_TYPE.UTC })}`
})
