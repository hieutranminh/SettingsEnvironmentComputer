...
const minDate = computed(() => {
  return getCurrentDate(TIMEZONE_TYPE.LOCAL).subtract(YEARS_TO_SUBTRACT, 'year').startOf('year').toDate()
})

const maxDate = computed(() => {
  return getCurrentDate(TIMEZONE_TYPE.LOCAL).endOf('year').toDate()
})
