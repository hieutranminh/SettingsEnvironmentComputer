...
// Types
import type { INewClientsRepeatFilterInterface } from '@/types/client-report/NewClientsRepeat'
import type { DateValue } from '@/types/Common'
// Utils
import { fromUnixTimestamp, getStartOf, toUnixTimestamp, getEndOf } from '@/utils/dateUtils'
const props = defineProps<{
  modelValue: INewClientsRepeatFilterInterface
}>()

const emit = defineEmits<{
  (e: 'update:modelValue', value: INewClientsRepeatFilterInterface): void
