...
export const FUNCTION_TYPE = {
  ...
  CLIENT_SEARCH:                       1,
  BOOKING_ASSISTANT:                   2,
  SERVICE_BOOKING_ITEMS:               3,
  CRM_FILTER_EXTRACTOR:                4,
  MESSAGE_GENERATOR:                   5,
  IMAGE_GENERATOR:                     6,
  REPORT_SUMMARY:                      7,
  COMPREHENSIVE_ANALYSIS_INSIGHTS:     8,
  STAFF_PERFORMANCE_ANALYSIS_INSIGHTS: 9,
  OPERATIONAL_TREND_ANALYSIS_INSIGHTS: 10,
  CRM_FILTER_CLASSIFY:                 11,
}
